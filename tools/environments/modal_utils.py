"""Shared Intellect-side execution flow for Modal transports.

This module deliberately stops at the Intellect boundary:
- command preparation
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"intellect_EOF_{uuid.uuid4().hex[:8]}"
