...
Trust levels:
  - builtin:   Ships with Intellect. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.intellect/\.env|\~/\.intellect/\.env',
     "intellect_env_access", "critical", "exfiltration",
     "directly references Intellect secrets file"),
    ...
    (r'\.intellect/config\.yaml|\.intellect/SOUL\.md',
     "intellect_config_mod", "critical", "persistence",
     "references Intellect configuration files directly"),
