...
|---------|------|------------|
| [v0.5.1](RELEASE_v0.5.1.md) | 2026-06-06 | **P0-P6 Security & Platform Hardening** — 18 PRs merged |
| [v0.5.0](RELEASE_v0.5.0.md) | 2026-03-28 | Hugging Face provider, Telegram topics, Modal SDK, Nix flake, supply chain |
| [v0.15.1](RELEASE_v0.15.1.md) | 2026-05-29 | Bug fixes, polish |
| [v0.15.0](RELEASE_v0.15.0.md) | 2026-05-24 | Big Refactor: `run_agent.py` 16k→3.8k, Gateway platform migration, Multi-user foundation |
...
| [v0.5.0](RELEASE_v0.5.0.md) | 2026-03-15 | Batch processing, parallel execution |
...
v0.15.1 —— Bug fixes
v0.4.2 —— Storage/Cache/MQ (joint PR)
v0.5.1 —— P0-P6 Security & Platform Hardening (18 PRs) ← current
```
