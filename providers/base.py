...
def _profile_user_agent() -> str:
    """Return a ``intellect-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from intellect_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"intellect-cli/{_ver}"
    except Exception:
        return "intellect-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # intellect-cli UA so the catalog endpoint is reachable.
