...
DEFAULT_DATASETS = [
    "ONTOWEB/swe-terminus-agent-glm-kimi-minimax",
    "ONTOWEB/intellect-agent-megascience-sft1",
    "ONTOWEB/Intellect-Agent-Thinking-GLM-4.7-SFT2",
    "ONTOWEB/Intellect-Agent-Thinking-GLM-4.7-SFT1",
    "ONTOWEB/terminal-tasks-glm-intellect-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "ONTOWEB/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload ONTOWEB/{output_name} {final_output}")
