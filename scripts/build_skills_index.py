#!/usr/bin/env python3
"""Build the Intellect Skills Index — a centralized JSON catalog of all skills.
...
`intellect skills search/install` can use it without hitting the GitHub API.
...
# Ensure INTELLECT_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Intellect Skills Index...", flush=True)
