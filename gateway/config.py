...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_intellect_home() / "sessions")
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.intellect/config.yaml (primary user-facing config)
    3. ~/.intellect/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
