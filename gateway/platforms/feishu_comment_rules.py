...
Config: ~/.intellect/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.intellect/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_intellect_home()`` helper (INTELLECT_HOME-aware and
...
RULES_FILE = get_intellect_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_intellect_home() / "feishu_comment_pairing.json"
