...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host INTELLECT_REDACT_SECRETS."""
...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        mock_result = {"success": True, "data": {"title": "ok", "url": "https://gitee.com/ontoweb/intellect-agent"}}
        with patch("tools.browser_tool._run_browser_command", return_value=mock_result), \
            ...
            result = browser_navigate("https://gitee.com/ontoweb/intellect-agent")
        parsed = json.loads(result)
