"""Tests for CodexEventProjector — codex item/* events → Intellect messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Intellect' message alternation invariant."""
