...
class TestServerRequestRouting:
    ...
    def test_mcp_elicitation_for_intellect_tools_auto_accepts(self):
        """When codex elicits on behalf of intellect-tools (our own callback),
