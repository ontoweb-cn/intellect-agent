...
def store(tmp_path, monkeypatch):
    ...
    ~/.intellect/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at intellect_state import time, before pytest's INTELLECT_HOME monkeypatch
    fires — the autouse fixture's INTELLECT_HOME override doesn't help here.)
    """
