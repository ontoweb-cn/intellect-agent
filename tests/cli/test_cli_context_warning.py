...
def _isolate(tmp_path, monkeypatch):
    """Isolate INTELLECT_HOME so tests don't touch real config."""
...
def cli_obj(_isolate):
    """Create a minimal IntellectCLI instance for banner testing."""
...
class TestLowContextWarning:
    ...
    def test_warning_for_below_minimum_context(self, cli_obj):
        """Warning shown when context is below Intellect' minimum."""
    ...
    def test_no_warning_at_boundary(self, cli_obj):
        """No warning at exactly Intellect' minimum context length."""
    ...
    def test_no_warning_above_boundary(self, cli_obj):
        """No warning above Intellect' minimum context length."""
