...
def test_new_command_rotates_intellect_session_id_env_and_context(tmp_path):
    ...
    assert cli.session_id != old_session_id
    assert os.environ["intellect_SESSION_ID"] == cli.session_id
    assert get_session_env("intellect_SESSION_ID") == cli.session_id
