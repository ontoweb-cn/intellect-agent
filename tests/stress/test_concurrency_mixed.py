...
def worker_loop(worker_id: int, intellect_home: str, result_file: str) -> None:
...
def reclaimer_loop(intellect_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="intellect_mixed_stress_")
    print(f"INTELLECT_HOME = {home}")
