...
old_session_id=<old>). This lets plugin engines (e.g. intellect-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See intellect-lcm#68: after Intellect compresses and mints a new physical session,
