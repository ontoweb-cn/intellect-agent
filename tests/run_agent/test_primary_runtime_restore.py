...
5. Recovery is skipped for aggregator providers (OpenRouter, OntoWeb)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_skipped_for_ontoweb_provider(self):
        agent = _make_agent(provider="ontoweb", base_url="https://inference.ontoweb.ontoweb.cn/v1")
        error = _make_transport_error("ReadTimeout")
