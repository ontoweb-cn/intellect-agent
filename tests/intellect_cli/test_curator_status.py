"""Tests for `intellect curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated INTELLECT_HOME with real agent-created skills on disk."""
    ...
    from intellect_cli import curator as curator_cli
