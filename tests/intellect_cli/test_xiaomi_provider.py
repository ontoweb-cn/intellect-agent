...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from intellect_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in intellect_OVERLAYS
        overlay = intellect_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify intellect doctor recognizes Xiaomi env vars."""
