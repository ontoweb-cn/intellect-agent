"""Tests for the specifier module + `intellect kanban specify` CLI surface.
...
from intellect_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `intellect kanban …` argparse surface directly."""
