...
The main() function in intellect_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `intellect -c model`
...
def _build_parser():
    """Build a minimal replica of the intellect top-level parser."""
