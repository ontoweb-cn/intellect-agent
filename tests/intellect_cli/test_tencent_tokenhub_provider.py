...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_providers_py(self):
        from intellect_cli.providers import normalize_provider
        assert normalize_provider("tencent") == "tencent-tokenhub"
        assert normalize_provider("tokenhub") == "tencent-tokenhub"
        assert normalize_provider("tencent-cloud") == "tencent-tokenhub"
        assert normalize_provider("tencentmaas") == "tencent-tokenhub"
...
# =============================================================================
# CANONICAL_PROVIDERS (intellect model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / ONTOWEB Portal curated lists
# =============================================================================


class TestTencentInOpenRouterAndNous:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and OntoWeb curated lists."""

    def test_in_openrouter_fallback(self):
        from intellect_cli.models import OPENROUTER_MODELS
    ...
    def test_in_ontoweb_provider_models(self):
        from intellect_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3-preview" in _PROVIDER_MODELS["ontoweb"]
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from intellect_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from intellect_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProviderLabel:
    ...
    def test_provider_label_function(self):
        from intellect_cli.models import provider_label
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in intellect_OVERLAYS
        overlay = intellect_OVERLAYS["tencent-tokenhub"]
    ...
    def test_get_provider(self):
        pdef = None
        try:
            from intellect_cli.providers import get_provider
...
class TestTencentTokenhubDoctor:
    """Verify intellect doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from intellect_cli.providers import intellect_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = intellect_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``intellect model`` routes it through the generic api_key_provider flow.
        """
        import inspect
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from intellect_cli.models import _KNOWN_PROVIDER_NAMES
