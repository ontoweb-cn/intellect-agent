"""Tests for the interactive session browser (`intellect sessions browse`).
...
from intellect_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """intellect sessions browse should be parseable."""
