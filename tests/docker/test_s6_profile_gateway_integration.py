...
The unit tests in tests/intellect_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned intellect-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/intellect")
from intellect_cli.service_manager import S6ServiceManager
