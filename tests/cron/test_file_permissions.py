...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("intellect_cli.config.get_config_path", return_value=config_path), \
             patch("intellect_cli.config.ensure_intellect_home"):
    ...
    def test_ensure_intellect_home_sets_0700(self):
        home = Path(self.tmpdir) / ".intellect"
        with patch("intellect_cli.config.get_intellect_home", return_value=home):
