...
Built for [Intellect Agent](https://gitee.com/ontoweb/intellect-agent). Usable in any coding agent. Canonical source lives here; synced to [`ONTOWEB/intellect-agent/skills/creative/ascii-video`](https://gitee.com/ontoweb/intellect-agent/tree/main/skills/creative/ascii-video) via PR.
