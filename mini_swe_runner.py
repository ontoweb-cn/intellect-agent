#!/usr/bin/env python3
"""
SWE Runner with Intellect Trajectory Format

A runner that uses Intellect-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Intellect-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Intellect-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Intellect format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Intellect-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Intellect-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Intellect Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Intellect-Agent's built-in execution environments
    and outputs trajectories in Intellect-Agent format.
    """
    ...
    def _convert_to_intellect_format(
        self,
        ...
        """
        Convert internal message format to Intellect trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Intellect trajectory format
        trajectory = self._convert_to_intellect_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Intellect trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Intellect Trajectory Format")
    print("=" * 60)
