...
from intellect_rust import HAS_COUNTERS, IterationBudget as _RustBudget

if HAS_COUNTERS and _RustBudget is not None:
    IterationBudget = _RustBudget  # type: ignore[assignment]
else:
