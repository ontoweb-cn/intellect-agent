...
#
# See: https://gitee.com/ontoweb/intellect-agent/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, OntoWeb) run before
    ...
    if status_code == 404:
        # OntoWeb API currently surfaces HA/NAS credit depletion as a paid model
