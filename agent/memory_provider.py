...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - intellect_home (str): The active INTELLECT_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.intellect``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "intellect").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'intellect memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], intellect_home: str) -> None:
        ...
        Called by 'intellect memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``intellect_home`` is the active INTELLECT_HOME directory path.
