...
providers (OpenRouter, OntoWeb, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Intellect/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Intellect'
    ...
    # is stricter (low/high). Clamp Intellect' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Intellect-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Intellect-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/OntoWeb max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (OntoWeb, OpenRouter,
