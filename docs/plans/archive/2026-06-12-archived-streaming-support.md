# Streaming LLM Response Support for Intellect Agent
...
```
intellect_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("intellect_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `intellect_cli/config.py` | 1 | +streaming config defaults |
...
intellect_STREAMING_ENABLED=true
```
