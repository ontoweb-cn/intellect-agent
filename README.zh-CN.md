...
它会通过 OAuth 登录、把 OntoWeb 设为推理服务商，并启用 Tool Gateway。随时用 `intellect portal status` 查看路由状态。完整说明见 [Tool Gateway 文档](https://intellect.ontoweb.cn/docs/user-guide/features/tool-gateway)。
