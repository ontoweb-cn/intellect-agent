"""Passkey/WebAuthn helpers for Intellect WebUI.
...
def registration_options(handler) -> dict[str, Any]:
    ...
    return {
        ...
        "user": {"id": _b64u(hashlib.sha256(rp_id.encode()).digest()[:16]), "name": "Intellect WebUI", "displayName": "Intellect WebUI"},
