...
legacy direct route; enabling ``INTELLECT_WEBUI_RUNTIME_ADAPTER=legacy-journal``
...
_RUNTIME_ADAPTER_ENV = "INTELLECT_WEBUI_RUNTIME_ADAPTER"
_RUNTIME_ADAPTER_DIRECT = "legacy-direct"
_RUNTIME_ADAPTER_JOURNAL = "legacy-journal"
_RUNTIME_ADAPTER_RUNNER_LOCAL = "runner-local"
_VALID_RUNTIME_ADAPTER_MODES = {_RUNTIME_ADAPTER_DIRECT, _RUNTIME_ADAPTER_JOURNAL, _RUNTIME_ADAPTER_RUNNER_LOCAL}
