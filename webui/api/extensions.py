...
_EXTENSION_DIR_ENV = "INTELLECT_WEBUI_EXTENSION_DIR"
_EXTENSION_SCRIPT_URLS_ENV = "INTELLECT_WEBUI_EXTENSION_SCRIPT_URLS"
_EXTENSION_STYLESHEET_URLS_ENV = "INTELLECT_WEBUI_EXTENSION_STYLESHEET_URLS"
...
def _read_url_list(env_name: str) -> List[str]:
    ...
    for item in raw.split(","):
        ...
        if _is_safe_asset_url(value):
            ...
            # in INTELLECT_WEBUI_EXTENSION_*_URLS doesn't disappear silently.
