"""
Intellect Web UI -- File upload: multipart parser and upload handler.
"""
import mimetypes
import os
import re as _re
...
def _attachment_root() -> Path:
    ...
    allowing operators to move the inbox with INTELLECT_WEBUI_ATTACHMENT_DIR.
    """
    override = os.getenv('INTELLECT_WEBUI_ATTACHMENT_DIR', '').strip()
    if override:
