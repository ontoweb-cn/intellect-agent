"""
Intellect Web UI -- Filesystem checkpoint (rollback) API.

Provides endpoints to list, diff, and restore filesystem checkpoints
created by the Intellect agent's CheckpointManager.  Checkpoints live at
``{intellect_home}/checkpoints/<hash>/`` as shadow git repositories.
"""
...
def _checkpoint_root() -> Path:
    return _intellect_home() / "checkpoints"
