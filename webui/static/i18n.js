...
const LOCALES = {
 ...
 folder_add_as_space_title: 'Add as Space?',
  ...
  members_setup_desc: 'Multi-user mode uses the intellect-agent membership database. ',
  ...
  members_toggle_label: 'Multi-User Mode',
  members_toggle_desc: 'Enable multi-user membership system',
  members_toggle_locked_title: 'Multi-User Unavailable',
  members_toggle_locked_desc: 'Set a WebUI admin password first before enabling multi-user mode. Click your avatar → Set Password.',
...
path_copied: '\u6587\u4ef6\u8def\u5f84\u5df2\u590d\u5236\u5230\u526a\u8d34\u677f',
 ...
 folder_add_as_space_title: '添加为工作区？',
  ...
  members_setup_desc: '多用户模式使用 intellect-agent 成员数据库。',
  ...
  members_toggle_label: '多用户模式',
  members_toggle_desc: '启用多用户成员系统',
  members_toggle_locked_title: '多用户模式不可用',
  members_toggle_locked_desc: '请先设置 WebUI 管理员密码，再启用多用户模式。点击右上角头像 → 设置密码。',
