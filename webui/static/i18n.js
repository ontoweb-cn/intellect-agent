...
const LOCALES = {
 ...
 folder_add_as_space_title: 'Add as Space?',
  ...
  settings_search_title: 'Built-in Web Search',
  settings_search_desc: 'Self-hosted SearXNG meta-search engine. No API key required.',
  settings_search_enable: 'Enable SearXNG search',
  settings_search_test: 'Test Connection',
  wiki_init_btn: 'Initialize Wiki',
  wiki_init_confirm_body: 'Create the standard LLM Wiki folder structure at {path}?',
  wiki_init_domain_prompt: 'Domain for this wiki (optional):',
  wiki_init_success: 'Wiki initialized.',
  wiki_init_failed: 'Failed to initialize wiki.',
  tab_wiki: 'Wiki',
  wiki_catalog_personal: 'Personal',
  wiki_catalog_teams: 'Teams',
  wiki_catalog_projects: 'Projects',
  wiki_catalog_global: 'Organization',
  wiki_pending_contributions: 'Pending reviews',
  wiki_empty_title: 'Select a wiki scope',
  wiki_empty_sub: 'Pick personal, team, or project wiki from the sidebar.',
  wiki_missing_wiki_title: 'Wiki not initialized',
  wiki_missing_wiki_sub: 'Initialize the wiki folder structure before building a vault.',
  wiki_no_vault_title: 'Vault not built',
  wiki_no_vault_sub: 'Wiki content is ready. Build the Quartz vault to browse it here.',
  wiki_building_title: 'Building vault',
  wiki_building_sub: 'Building vault…',
  wiki_building_eta_note: 'Estimated progress',
  wiki_failed_title: 'Vault build failed',
  wiki_failed_unknown: 'Build failed.',
  wiki_build_btn: 'Build Vault',
  wiki_rebuild_btn: 'Rebuild vault',
  wiki_retry_btn: 'Retry',
  wiki_view_logs: 'View logs',
  wiki_open_tab: 'Open in new tab',
  wiki_build_queued: 'Vault build queued.',
  wiki_build_failed: 'Failed to trigger vault build.',
  wiki_badge_ready: 'Ready',
  wiki_badge_building: 'Building',
  wiki_badge_empty: 'Empty',
  wiki_badge_missing: 'Missing',
  wiki_badge_failed: 'Failed',
  wiki_badge_no_vault: 'No vault',
  wiki_status_missing_at: 'No LLM Wiki directory was found at {path}.',
  vault_wiki_settings_title: 'LLM Wiki & Vault',
  vault_wiki_settings_desc: 'Initialize your knowledge base and configure how /vault/ URLs are routed.',
  vault_wiki_settings_desc_single: 'Initialize your knowledge base and configure vault rebuild triggers.',
  vault_routing_title: 'Vault URL routing',
  vault_routing_context: 'Context-aware',
  vault_routing_context_desc: '/vault/ opens the wiki for your active project or team.',
  vault_routing_explicit: 'Explicit paths only',
  vault_routing_explicit_desc: '/vault/ opens the global wiki; scoped wikis use /vault/p/, /vault/t/, or /vault/m/.',
  vault_routing_saved: 'Vault routing saved.',
  vault_routing_save_failed: 'Failed to save vault routing.',
  vault_routing_current: 'Vault routing: {mode}',
  vault_build_trigger_title: 'Build trigger',
  vault_build_trigger_auto: 'Auto — rebuild after agent sessions when wiki changes',
  vault_build_trigger_manual: 'Manual — rebuild only via button or API',
  vault_build_trigger_scheduled: 'Scheduled — rebuild on a cron schedule (requires gateway)',
  vault_build_schedule_label: 'Cron schedule',
  vault_build_schedule_hint: '5-field cron expression, e.g. 0 * * * * = every hour',
  vault_scheduler_last: 'Last scheduled run',
  vault_scheduler_next: 'Next estimated run',
  vault_scheduler_gateway_hint: 'Scheduled builds require intellect gateway to be running.',
  vault_config_saved: 'Vault settings saved.',
  search_tab: 'Search',
  ...
  compression_exhausted_label: 'Context compression exhausted',
  compression_exhausted_hint: 'Automatic compression could not free enough space. Focus on the current topic and compress, or start a new session.',
  compression_exhausted_focus_label: 'Focus topic',
  compression_exhausted_cta_compress: 'Focused compress',
  compression_exhausted_cta_new: 'New session',
  settings_label_update_channel: 'Update channel',
  settings_desc_update_channel: 'Stable tracks releases/upstream (default). Experimental uses a named remote branch (default origin/experimental; override with INTELLECT_WEBUI_EXPERIMENTAL_REF). Apply switches to that track. Does not change CLI intellect update.',
  settings_opt_update_channel_stable: 'Stable',
  settings_opt_update_channel_experimental: 'Experimental',
  ...
  members_panel_desc: 'People, OAuth identities, API tokens, and teams for this profile.',
    members_section_password: 'Password',
    members_section_identities: 'Linked Accounts',
    members_section_tokens: 'API Tokens',
    members_section_invites: 'Invites & Approvals',
    members_section_activity: 'Admin Activity',
    members_activity_hint: 'Recent owner/admin actions (approvals, invites, deletions).',
    members_activity_empty: 'No admin activity recorded yet.',
    audit_col_time: 'Time',
    audit_col_action: 'Action',
    audit_col_actor: 'Actor',
    audit_col_target: 'Target',
    audit_col_source: 'Source',
    audit_action_approve: 'Approved registration',
    audit_action_reject: 'Rejected registration',
    audit_action_invite: 'Created invite',
    audit_action_redeem: 'Redeemed invite',
    audit_action_delete: 'Deleted member',
    audit_action_deactivate: 'Deactivated member',
    audit_action_activate: 'Activated member',
    members_section_list: 'Member List',
    member_id: 'ID',
    ...
    member_reset_pw: 'Reset PW',
    member_reset_pw_confirm_title: 'Reset Password',
    member_reset_pw_confirm_msg: 'Generate a temporary password? The member will be required to change it on next login.',
    member_reset_pw_done_title: 'Password Reset',
    member_reset_pw_temp_label: 'Temporary password:',
    member_reset_pw_temp_hint: 'Share this with the member. They must change it on next login.',
    member_reset_pw_ok: 'Password reset',
    copy_and_close: 'Copy & Close',
    member_delete: 'Delete',
    member_delete_confirm_title: 'Delete Member',
    member_delete_confirm_msg: 'Permanently delete this member? This cannot be undone.',
    members_no_members: 'No members found.',
    member_self: 'You',
    member_owner_protected: 'Owner — owner only',
    member_set_admin: 'Set as Admin',
    member_set_admin_confirm_title: 'Set as Admin',
    member_set_admin_confirm_msg: 'Grant admin role to this member? They will be able to invite members, create teams, and manage team membership.',
    member_set_admin_ok: 'Admin role granted',
    member_set_owner: 'Set as Owner',
    member_set_owner_confirm_title: 'Transfer Ownership',
    member_set_owner_confirm_msg: 'Transfer profile ownership to this member? This gives them full control including the ability to delete members and change roles. This cannot be easily undone.',
    member_set_owner_ok: 'Ownership transferred',
    member_already_role: 'Member already has this role',
  members_disabled: 'Multi-user members were removed. Isolation is profile-based; use intellect oauth for provider OAuth.',
  members_sign_in_first: 'Sign in with the WebUI password to continue.',
  ...
  members_project_id: 'Project id',
  members_join_project: 'Request join',
  ...
  member_project_banner: 'Select an active project to continue.',
  ...
  profile_section_projects: 'Projects',
  ...
  teams_group_mine: 'My teams',
  teams_group_manage: 'Team management',
  teams_section_mine: 'My teams',
  teams_section_manage: 'Team management',
  teams_section_approvals: 'Member approvals',
  teams_manage_empty: 'No team management actions available.',
  teams_tools: 'Team tools',
  teams_leave: 'Leave',
  teams_archive: 'Archive',
  teams_soul_refresh: 'Refresh SOUL',
  teams_soul_refreshed: 'SOUL refreshed',
  teams_archived: 'Team archived',
  teams_left: 'Left team',
  ...
  teams_role_admin: 'Team admin',
  teams_members_manage: 'Team members',
  teams_no_admin_teams: 'You are not a team admin on any team.',
  teams_no_members: 'No members.',
  teams_promote_admin: 'Make admin',
  teams_demote_admin: 'Remove admin',
  teams_admin_updated: 'Team role updated',
  teams_remove_member: 'Remove',
  teams_member_removed: 'Member removed',
  teams_open_panel: 'Open Teams panel',
  projects_open_panel: 'Open Projects panel',
  projects_panel_desc: 'Join projects, pick an active project, and approve requests.',
  projects_group_mine: 'My projects',
  projects_group_manage: 'Project management',
  projects_section_mine: 'My projects',
  projects_section_manage: 'Project management',
  projects_section_approvals: 'Member approvals',
  projects_manage_empty: 'No project management actions available.',
  projects_tools: 'Project tools',
  projects_leave: 'Leave',
  projects_archive: 'Archive',
  projects_archived: 'Project archived',
  projects_left: 'Left project',
  projects_disabled_members: 'Enable members.enabled in config.yaml first.',
  projects_disabled_projects: 'Enable members.projects.enabled in config.yaml.',
  projects_sign_in_first: 'Sign in to manage projects.',
  projects_multi_banner: 'Select an active project from the account menu.',
  projects_my_projects: 'My projects',
  projects_no_memberships: 'No project memberships yet.',
  projects_active: 'Active',
  projects_use: 'Use',
  projects_join: 'Join a project',
  projects_create: 'Create project',
  projects_display_name: 'Display name',
  projects_no_pending: 'No pending join requests.',
  projects_approve: 'Approve',
  projects_reject: 'Reject',
  projects_active_set: 'Active project updated',
  projects_created: 'Project created',
  projects_approved: 'Member approved',
  projects_rejected: 'Request rejected',
  projects_role_admin: 'Project admin',
  projects_members_manage: 'Project members',
  projects_no_admin_projects: 'You are not a project admin on any project.',
  projects_no_members: 'No members.',
  projects_promote_admin: 'Make admin',
  projects_demote_admin: 'Remove admin',
  projects_admin_updated: 'Project role updated',
  projects_remove_member: 'Remove',
  projects_member_removed: 'Member removed',
  projects_soul_edit: 'Project SOUL',
  projects_soul_load: 'Load',
  projects_soul_save: 'Save SOUL',
  projects_soul_saved: 'SOUL saved',
  projects_link_teams: 'Linked teams',
  projects_link_team: 'Link team',
  projects_unlink_team: 'Unlink',
  projects_team_linked: 'Team linked',
  projects_team_unlinked: 'Team unlinked',
  projects_no_linked_teams: 'No linked teams.',
  member_projects: 'Projects',
  projects_load_failed: 'Could not load projects panel.',
  members_setup_title: 'Members (removed)',
  members_setup_desc: 'Multi-user members/teams are not available. Use profiles for isolation and intellect oauth for provider OAuth.',
  members_setup_off: 'Multi-user members are not available (permanent single-user).',
  members_setup_unavailable: 'Multi-user members API is not available.',
  members_setup_mode: 'Mode',
  members_toggle_label: 'Multi-User Mode (unavailable)',
  members_toggle_desc: 'Multi-user membership is permanently disabled in this build.',
  members_toggle_locked_title: 'Multi-User Unavailable',
  members_toggle_locked_desc: 'Intellect Agent is permanently single-user. Use profiles for isolation.',
  teams_toggle_label: 'Teams',
  teams_toggle_desc: 'Enable team collaboration features',
  projects_toggle_label: 'Projects',
  projects_toggle_desc: 'Enable project workspaces and secrets',
  members_bootstrap_label: 'Create Admin',
  members_bootstrap_desc: 'Create your admin account',
  members_bootstrap_btn: 'Run',
  members_bootstrap_dialog_title: 'Create Admin Account',
  members_bootstrap_id_placeholder: 'Member ID (e.g. admin)',
  members_bootstrap_pw_placeholder: 'Password',
  members_bootstrap_pw_confirm_placeholder: 'Confirm password',
  members_bootstrap_id_required: 'Member ID is required',
  members_bootstrap_pw_short: 'Password must be at least 8 characters',
  members_bootstrap_pw_mismatch: 'Passwords do not match',
  members_bootstrap_ok: 'Admin account created',
  storage_bootstrap_title: 'Storage',
  storage_pg_recommended: 'PostgreSQL (recommended)',
  storage_pg_desc: 'Multi-user, OAuth, and multi-worker WebUI',
  storage_sqlite_only: 'SQLite only (single process)',
  storage_sqlite_desc: 'No extra services; not for multiple WebUI workers',
  storage_pg_dsn_placeholder: 'postgresql://user:pass@host:5432/intellect',
  storage_pg_or_fields: 'Or host / port / database / user / password',
  storage_pg_password: 'Password',
  storage_enable_redis: 'Enable Redis (cache + events, for multi-worker)',
  storage_test_pg: 'Test connection',
  storage_migrate_dry_run: 'Test & migrate (dry-run)',
  storage_migrate_dry_run_ok: 'Dry-run OK — ready to create admin',
  storage_migrate_failed: 'Migration check failed',
  storage_migrate_rows: 'Rows to copy',
  storage_migrate_dry_run_required: 'Run Test & migrate (dry-run) first',
  storage_continue_sqlite: 'Continue with SQLite only…',
  storage_sqlite_confirm_title: 'Use SQLite only?',
  storage_sqlite_confirm_msg: 'SQLite cannot run multiple WebUI workers or HA. OAuth and state stay in state.db. Continue?',
  storage_sqlite_confirm_btn: 'Use SQLite',
  members_bootstrap_dialog_title: '创建管理员账户',
  members_bootstrap_id_placeholder: '成员 ID（如 admin）',
  members_bootstrap_pw_placeholder: '密码',
  members_bootstrap_pw_confirm_placeholder: '确认密码',
  members_bootstrap_id_required: '成员 ID 不能为空',
  members_bootstrap_pw_short: '密码至少需要 8 个字符',
  members_bootstrap_pw_mismatch: '两次输入的密码不一致',
  members_disable_confirm_title: 'Disable Multi-User?',
  members_disable_confirm_msg: 'This will disable all member accounts, teams, and projects. Continue?',
  ...
  members_redeem_hint: 'Enter an invite code from an administrator to join this Intellect profile.',
  ...
  members_identity_linked: 'OAuth account linked.',
  members_oauth_err_generic: 'OAuth link failed. Try again.',
  members_oauth_err_token_exchange: 'OAuth token exchange failed. Try linking again.',
  members_oauth_err_bind_failed: 'Could not bind this OAuth account.',
  members_oauth_err_missing_claims: 'OAuth provider did not return identity details.',
  members_oauth_err_oauth_denied: 'OAuth authorization was cancelled.',
  ...
  kanban_assignee_agents_label: 'Intellect agents',
  ...
  tab_todos: 'Todos',
  todos_empty_title: 'Current session tasks',
  todos_empty_sub: 'Agent todo items for this session are listed in the sidebar.',
  tab_insights: 'Insights',
  tab_journey: 'Journey',
  journey_title: 'Learning journey',
  journey_empty_title: 'No learning yet',
  journey_empty_body: 'Use /learn to distill skills, the memory tool to save notes, or install skills from the hub.',
  journey_legend_skill: 'Skill',
  journey_legend_memory: 'Memory',
  journey_stat_skills: 'Learned skills',
  journey_stat_memories: 'Memories',
  journey_stat_edges: 'Links',
  journey_edit: 'Edit',
  journey_delete: 'Delete',
  journey_open_skills: 'Skills panel',
  journey_open_memory: 'Memory panel',
  journey_delete_skill_hint: 'Deleting a skill archives it — restore with intellect curator restore.',
  journey_uninstall: 'Uninstall',
  journey_uninstall_hub_hint: 'Hub skills are uninstalled (not archived). Reinstall from the Skills panel.',
  journey_uninstall_hub_confirm: 'Uninstall this hub skill? It is not archived — reinstall from Skills.',
  journey_uninstalled: 'Uninstalled',
  journey_stale_refresh: 'Graph changed — refreshing…',
  journey_edit_prompt: 'Edit content:',
  journey_edit_content: 'Content',
  journey_save: 'Save',
  journey_saved: 'Saved',
  journey_deleted: 'Deleted',
  journey_delete_skill_confirm: 'Archive this skill? Restore via intellect curator restore.',
  journey_delete_memory_confirm: 'Delete this memory chunk?',
  journey_date_unknown: 'unknown',
  journey_bucket_unknown: 'Undated',
  journey_loaded: 'Node loaded',
  ...
  // Session attention badges
  session_attention_approval: (n) => `${n || 1} approval${n === 1 ? '' : 's'}`,
  session_attention_clarify: (n) => `${n || 1} question${n === 1 ? '' : 's'}`,
  session_attention_generic: (n) => `Needs attention`,
  session_attention_approval_title: (n) => `${n || 1} pending approval${n === 1 ? '' : 's'}`,
  session_attention_clarify_title: (n) => `${n || 1} clarification${n === 1 ? '' : 's'} needed`,
  session_attention_generic_title: (n) => `Needs attention`,
  ...
  sign_out: 'Sign Out',
  // Providers panel
  providers_tab_title: 'Models',
  providers_section_title: 'Models',
  providers_section_meta: 'Manage API keys for AI model providers. Changes take effect immediately.',
  ...
  settings_tab_oauth_providers: 'Auth Services',
  settings_oauth_providers_title: 'Auth Services',
  settings_oauth_providers_meta: 'Manage login OAuth providers for member authentication (GitHub, Google, etc.).',
  oauth_yaml_migration_title: 'Legacy config.yaml OAuth providers',
  oauth_yaml_migration_body: '{count} provider(s) are still defined under members.oauth.providers in config.yaml. Provider settings now live in state.db (this panel). Migrate once on the server:',
  oauth_yaml_migration_marker_note: 'A prior migration ran; clear the YAML list when ready.',
  oauth_providers_add: '+ Add Provider',
  oauth_providers_add_title: 'Add OAuth Provider',
  oauth_providers_empty: 'No OAuth providers configured.',
  oauth_providers_enabled: 'Enabled',
  oauth_providers_disabled: 'Disabled',
  oauth_providers_builtin: 'Built-in',
  oauth_providers_custom: 'Custom',
  oauth_providers_enable: 'Enable',
  oauth_providers_disable: 'Disable',
  oauth_providers_saved: 'Provider saved',
  oauth_providers_create: 'Create',
  oauth_providers_created: 'Provider created',
  oauth_providers_deleted: 'Provider deleted',
  oauth_providers_delete_title: 'Delete OAuth Provider',
  oauth_providers_delete_msg: 'Remove this OAuth provider? This cannot be undone.',
  oauth_providers_id_name_required: 'Provider ID and Name are required',
  oauth_status_configured: 'Configured',
  oauth_status_authenticated: 'Authenticated',
  oauth_status_partial: 'Incomplete',
  oauth_status_not_configured: 'Not configured',
  oauth_tab_login: 'Login Auth',
  oauth_tab_model: 'Model Auth',
  oauth_tab_server: 'Server Auth',
  oauth_field_id: 'Provider ID',
  oauth_field_name: 'Display Name',
  oauth_field_auth_flow: 'Auth Flow',
  oauth_field_usage: 'Usage',
  oauth_field_client_id: 'Client ID',
  oauth_field_client_secret: 'Client Secret',
  oauth_field_authorize_url: 'Authorize URL',
  oauth_field_token_url: 'Token URL',
  oauth_field_userinfo_url: 'Userinfo URL',
  oauth_field_scopes: 'Scopes',
  oauth_field_oidc_discovery_url: 'OIDC Discovery URL',
  oauth_field_device_code_url: 'Device Code URL',
  oauth_field_header_name: 'Header Name',
  oauth_field_map_mode: 'Map Mode',
  oauth_field_logo: 'Logo',
  oauth_field_logo_hint: 'Upload SVG or PNG file (optional)',
  oauth_flow_pkce_loopback: 'PKCE Loopback',
  oauth_flow_oidc_discovery: 'OIDC Discovery',
  oauth_flow_device_code: 'Device Code',
  oauth_flow_trusted_header: 'Trusted Header',
  providers_save: 'Save',
  ...
  agents_empty_title: 'Select an agent',
  profiles_empty_title: 'Select a profile',
  agents_empty_sub: 'Pick an agent from the sidebar to view and edit its settings, or create a new one.',
  ...
  agent_api_keys_configured: 'API keys configured',
  profile_api_keys_configured: 'API keys configured',
  agent_gateway_running: 'Gateway running',
  profile_gateway_running: 'Gateway running',
  agent_gateway_stopped: 'Gateway stopped',
  profile_gateway_stopped: 'Gateway stopped',
  agent_active: 'ACTIVE',
  profile_active: 'ACTIVE',
  agent_no_configuration: 'No configuration',
  profile_no_configuration: 'No configuration',
  agent_skill_count: (count) => `${count} skill${count === 1 ? '' : 's'}`,
  profile_skill_count: (count) => `${count} skill${count === 1 ? '' : 's'}`,
  agent_use: 'Use',
  profile_use: 'Use',
  agent_switch_title: 'Switch to this agent',
  profile_switch_title: 'Switch to this profile',
  agent_delete_title: 'Delete this agent',
  profile_delete_title: 'Delete this profile',
  agent_default_label: '(default)',
  profile_default_label: '(default)',
  agent_name_placeholder: 'Agent name (lowercase, a-z 0-9 hyphens)',
  profile_name_placeholder: 'Profile name (lowercase, a-z 0-9 hyphens)',
  agent_clone_label: 'Clone config from active agent',
  profile_clone_label: 'Clone config from active profile',
  agent_model_label: 'Model / provider',
  profile_model_label: 'Model / provider',
  agent_model_hint: 'Choose from configured providers and models for this new agent.',
  profile_model_hint: 'Choose from configured providers and models for this new profile.',
  agent_model_use_default: 'Use active agent default',
  profile_model_use_default: 'Use active profile default',
  agent_base_url_placeholder: 'Base URL (optional, e.g. http://localhost:11434)',
  profile_base_url_placeholder: 'Base URL (optional, e.g. http://localhost:11434)',
  agent_api_key_placeholder: 'API key (optional)',
  profile_api_key_placeholder: 'API key (optional)',
  manage_agents: 'Manage agents',
  manage_profiles: 'Manage profiles',
  agents_load_failed: 'Failed to load agents',
  profiles_load_failed: 'Failed to load profiles',
  agent_switched_new_conversation: (name) => `Switched to agent: ${name} — new conversation started`,
  profile_switched_new_conversation: (name) => `Switched to profile: ${name} — new conversation started`,
  agent_switched: (name) => `Switched to agent: ${name}`,
  profile_switched: (name) => `Switched to profile: ${name}`,
  agent_name_rule: 'Lowercase letters, numbers, hyphens, underscores only',
  profile_name_rule: 'Lowercase letters, numbers, hyphens, underscores only',
  agent_base_url_rule: 'Base URL must start with http:// or https://',
  profile_base_url_rule: 'Base URL must start with http:// or https://',
  agent_created: (name) => `Agent created: ${name}`,
  profile_created: (name) => `Profile created: ${name}`,
  agent_delete_confirm_title: (name) => `Delete agent "${name}"?`,
  profile_delete_confirm_title: (name) => `Delete profile "${name}"?`,
  agent_delete_confirm_message: 'All sessions, config, skills, and memory for this agent will be permanently deleted. This cannot be undone.',
  ...
  agent_deleted: (name) => `Agent deleted: ${name}`,
  ...
  cron_agent_label: 'Agent',
  cron_profile_label: 'Profile',
  cron_agent_server_default: 'server default',
  cron_profile_server_default: 'server default',
  cron_agent_server_default_hint: 'Uses the WebUI server default agent at run time. Existing jobs without an agent keep this legacy behavior.',
  ...
  // profile form
  agent_name_label: 'Name',
  profile_name_label: 'Name',
  agent_base_url_label: 'Base URL',
  profile_base_url_label: 'Base URL',
  agent_api_key_label: 'API key',
  ...
  // Memory Provider (System settings)
  memory_provider_title: 'Memory Provider',
  memory_provider_desc: 'Select and configure an external memory backend for the agent.',
  memory_provider_select: 'Select provider',
  memory_provider_builtin: 'Built-in only (MEMORY.md + USER.md)',
  memory_provider_active: 'Active',
  memory_provider_inactive: 'Not configured',
  memory_provider_not_available: 'not available',
  memory_provider_save: 'Save Configuration',
  memory_provider_saved: 'Memory provider configuration saved. Restart agent to apply.',
  memory_provider_save_failed: 'Failed to save configuration.',
  memory_provider_unavailable: 'Memory provider API unavailable (intellect-agent required).',
  memory_provider_load_failed: 'Failed to load provider config.',
  memory_provider_no_config: 'This provider has no configurable options.',
  memory_provider_secret_set: '(set)',
  memory_provider_secret_change: 'Change',
  memory_provider_secret_hide: 'Hide',
  memory_provider_restart_hint: 'Provider changes require an agent restart to take effect.',
 },
 zh: {
  offline_title: '连接已断开',
...
path_copied: '\u6587\u4ef6\u8def\u5f84\u5df2\u590d\u5236\u5230\u526a\u8d34\u677f',
 ...
 folder_add_as_space_title: '添加为工作区？',
  ...
  compression_exhausted_label: '上下文压缩已耗尽',
  compression_exhausted_hint: '自动压缩无法腾出足够空间。请聚焦当前主题再压缩，或开始新会话。',
  compression_exhausted_focus_label: '聚焦主题',
  compression_exhausted_cta_compress: '聚焦压缩',
  compression_exhausted_cta_new: '新会话',
  settings_label_update_channel: '更新通道',
  settings_desc_update_channel: 'Stable 跟踪发行版/上游（默认）。Experimental 使用命名远程分支（默认 origin/experimental；可用 INTELLECT_WEBUI_EXPERIMENTAL_REF 覆盖）。Apply 会切换到该轨。不影响 CLI intellect update。',
  settings_opt_update_channel_stable: 'Stable',
  settings_opt_update_channel_experimental: 'Experimental',
  settings_label_whats_new_summary: "Summarize What's New with AI",
  ...
  kanban_assignee_agents_label: 'Intellect 配置',
  ...
  tab_todos: '待办',
  todos_empty_title: '当前会话任务',
  todos_empty_sub: '本会话的 Agent 待办项显示在左侧边栏。',
  tab_insights: '统计',
  tab_journey: '学习历程',
  journey_title: '学习历程',
  journey_empty_title: '尚无学习记录',
  journey_empty_body: '使用 /learn 提炼技能、memory 工具保存笔记，或从 Hub 安装技能。',
  journey_legend_skill: '技能',
  journey_legend_memory: '记忆',
  journey_stat_skills: '已学技能',
  journey_stat_memories: '记忆块',
  journey_stat_edges: '关联',
  journey_edit: '编辑',
  journey_delete: '删除',
  journey_open_skills: '技能面板',
  journey_open_memory: '记忆面板',
  journey_delete_skill_hint: '删除技能会归档 — 可用 intellect curator restore 恢复。',
  journey_uninstall: '卸载',
  journey_uninstall_hub_hint: 'Hub 技能会卸载（不会归档）。请从技能面板重新安装。',
  journey_uninstall_hub_confirm: '卸载此 Hub 技能？不会归档 — 可从技能面板重新安装。',
  journey_uninstalled: '已卸载',
  journey_stale_refresh: '图谱已变化 — 正在刷新…',
  journey_edit_prompt: '编辑内容：',
  journey_edit_content: '内容',
  journey_save: '保存',
  journey_saved: '已保存',
  journey_deleted: '已删除',
  journey_delete_skill_confirm: '归档此技能？可通过 intellect curator restore 恢复。',
  journey_delete_memory_confirm: '删除此记忆块？',
  journey_date_unknown: '未知',
  journey_bucket_unknown: '未标注日期',
  journey_loaded: '已加载',
  ...
  members_panel_desc: '本配置下的成员、OAuth 身份、API 令牌与团队。',
    members_section_password: '账号密码',
    members_section_identities: '三方账号绑定',
    members_section_tokens: 'API 令牌',
    members_section_invites: '邀请审核',
    members_section_activity: '管理活动',
    members_activity_hint: '最近的配置文件管理操作（审批、邀请、删除等）。',
    members_activity_empty: '暂无管理活动记录。',
    audit_col_time: '时间',
    audit_col_action: '操作',
    audit_col_actor: '操作者',
    audit_col_target: '目标',
    audit_col_source: '来源',
    audit_action_approve: '批准注册',
    audit_action_reject: '拒绝注册',
    audit_action_invite: '创建邀请',
    audit_action_redeem: '兑换邀请',
    audit_action_delete: '删除成员',
    audit_action_deactivate: '停用成员',
    audit_action_activate: '启用成员',
    members_section_list: '成员列表',
    member_id: 'ID',
    member_display_name: '名称',
    member_role: '角色',
    member_teams: '团队',
    member_status: '状态',
    member_actions: '操作',
    member_active: '活跃',
    member_inactive: '停用',
    member_deactivate: '停用',
    member_activate: '启用',
    member_reset_pw: '重置密码',
    member_reset_pw_confirm_title: '重置密码',
    member_reset_pw_confirm_msg: '生成临时密码？成员下次登录时将被要求修改密码。',
    member_reset_pw_done_title: '密码已重置',
    member_reset_pw_temp_label: '临时密码：',
    member_reset_pw_temp_hint: '请将此密码告知成员。成员下次登录时需强制修改。',
    member_reset_pw_ok: '密码已重置',
    copy_and_close: '复制并关闭',
    member_delete: '删除',
    member_delete_confirm_title: '删除成员',
    member_delete_confirm_msg: '永久删除此成员？此操作不可撤销。',
    members_no_members: '未找到成员。',
    member_self: '本人',
    member_owner_protected: 'Owner 账号 — 仅 owner 可操作',
    member_set_admin: '设为管理员',
    member_set_admin_confirm_title: '设为管理员',
    member_set_admin_confirm_msg: '授予此成员管理员角色？他们将能够邀请成员、创建团队并管理团队成员。',
    member_set_admin_ok: '管理员角色已授予',
    member_set_owner: '设为超级管理员',
    member_set_owner_confirm_title: '转移所有权',
    member_set_owner_confirm_msg: '将配置所有权转移给此成员？这将赋予他们完全控制权，包括删除成员和更改角色的能力。此操作不可轻易撤销。',
    member_set_owner_ok: '所有权已转移',
    member_already_role: '成员已拥有此角色',
  members_disabled: '多用户成员功能已移除。隔离请用 profile；提供商 OAuth 请用 intellect oauth。',
  members_sign_in_first: '请使用 WebUI 密码登录后继续。',
  ...
  teams_group_mine: '我的团队',
  teams_group_manage: '团队管理',
  teams_section_mine: '我的团队',
  teams_section_manage: '团队管理',
  teams_section_approvals: '成员审批',
  teams_manage_empty: '暂无团队管理操作。',
  teams_tools: '团队工具',
  teams_leave: '离开',
  teams_archive: '归档',
  teams_soul_refresh: '刷新 SOUL',
  teams_soul_refreshed: 'SOUL 已刷新',
  teams_archived: '团队已归档',
  teams_left: '已离开团队',
  ...
  teams_role_admin: '团队管理员',
  teams_members_manage: '团队成员',
  teams_no_admin_teams: '您不是任何团队的管理员。',
  teams_no_members: '暂无成员。',
  teams_promote_admin: '设为管理员',
  teams_demote_admin: '取消管理员',
  teams_admin_updated: '团队角色已更新',
  teams_remove_member: '移除',
  teams_member_removed: '成员已移除',
  teams_open_panel: '打开团队面板',
  tab_projects: '项目',
  members_project_id: '项目 ID',
  members_join_project: '申请加入',
  projects_open_panel: '打开项目面板',
  projects_panel_desc: '加入项目、选择活跃项目、审批加入请求。',
  projects_group_mine: '我的项目',
  projects_group_manage: '项目管理',
  projects_section_mine: '我的项目',
  projects_section_manage: '项目管理',
  projects_section_approvals: '成员审批',
  projects_manage_empty: '暂无项目管理操作。',
  projects_tools: '项目工具',
  projects_leave: '离开',
  projects_archive: '归档',
  projects_archived: '项目已归档',
  projects_left: '已离开项目',
  projects_disabled_members: '请先在 config.yaml 中启用 members.enabled。',
  projects_disabled_projects: '请先在 config.yaml 中启用 members.projects.enabled。',
  projects_sign_in_first: '请先登录以管理项目。',
  projects_multi_banner: '请在账户菜单中选择活跃项目。',
  projects_my_projects: '我的项目',
  projects_no_memberships: '尚未加入任何项目。',
  projects_active: '当前',
  projects_use: '使用',
  projects_join: '加入项目',
  projects_create: '创建项目',
  projects_display_name: '显示名称',
  projects_no_pending: '暂无待审批的加入请求。',
  projects_approve: '批准',
  projects_reject: '拒绝',
  projects_active_set: '已更新活跃项目',
  projects_created: '项目已创建',
  projects_approved: '已批准成员',
  projects_rejected: '已拒绝请求',
  projects_role_admin: '项目管理员',
  projects_members_manage: '项目成员',
  projects_no_admin_projects: '您不是任何项目的管理员。',
  projects_no_members: '暂无成员。',
  projects_promote_admin: '设为管理员',
  projects_demote_admin: '取消管理员',
  projects_admin_updated: '项目角色已更新',
  projects_remove_member: '移除',
  projects_member_removed: '成员已移除',
  projects_soul_edit: '项目 SOUL',
  projects_soul_load: '加载',
  projects_soul_save: '保存 SOUL',
  projects_soul_saved: 'SOUL 已保存',
  projects_link_teams: '关联团队',
  projects_link_team: '关联团队',
  projects_unlink_team: '取消关联',
  projects_team_linked: '团队已关联',
  projects_team_unlinked: '已取消关联',
  projects_no_linked_teams: '暂无关联团队。',
  member_projects: '项目',
  projects_load_failed: '无法加载项目面板。',
  members_setup_title: '成员（已移除）',
  members_setup_desc: '多用户成员/团队不可用。请用 profile 隔离，或用 intellect oauth 配置提供商 OAuth。',
  members_setup_off: '多用户成员不可用（永久单用户）。',
  members_setup_unavailable: '多用户成员 API 不可用。',
  members_setup_mode: '模式',
  members_toggle_label: '多用户模式（不可用）',
  members_toggle_desc: '此构建永久关闭多用户成员系统。',
  members_toggle_locked_title: '多用户模式不可用',
  members_toggle_locked_desc: 'Intellect Agent 永久单用户。请用 profile 做隔离。',
  teams_toggle_label: '团队',
  teams_toggle_desc: '启用团队协作功能',
  projects_toggle_label: '项目',
  projects_toggle_desc: '启用项目工作区与密钥',
  members_bootstrap_label: '创建管理员',
  members_bootstrap_desc: '创建你的管理员账户',
  members_bootstrap_btn: '执行',
  members_bootstrap_ok: '管理员账户已创建',
  members_bootstrap_dialog_title: '创建管理员账户',
  members_bootstrap_id_placeholder: '成员 ID（如 admin）',
  members_bootstrap_pw_placeholder: '密码',
  members_bootstrap_pw_confirm_placeholder: '确认密码',
  ...
  members_bootstrap_pw_short: '密码至少需要 8 个字符',
  members_bootstrap_pw_mismatch: '两次输入的密码不一致',
  storage_bootstrap_title: '存储',
  storage_pg_recommended: 'PostgreSQL（推荐）',
  storage_pg_desc: '多用户、OAuth 与多进程 WebUI',
  storage_sqlite_only: '仅 SQLite（单进程）',
  storage_sqlite_desc: '无需额外服务；不支持多 WebUI worker',
  storage_pg_dsn_placeholder: 'postgresql://user:pass@host:5432/intellect',
  storage_pg_or_fields: '或填写主机 / 端口 / 库名 / 用户 / 密码',
  storage_pg_password: '密码',
  storage_enable_redis: '启用 Redis（缓存与事件，多 worker 时需要）',
  storage_test_pg: '测试连接',
  storage_migrate_dry_run: '测试并迁移（dry-run）',
  storage_migrate_dry_run_ok: 'Dry-run 通过 — 可创建管理员',
  storage_migrate_failed: '迁移检查失败',
  storage_migrate_rows: '待复制行数',
  storage_migrate_dry_run_required: '请先完成「测试并迁移（dry-run）」',
  storage_continue_sqlite: '仍使用仅 SQLite…',
  storage_sqlite_confirm_title: '仅使用 SQLite？',
  storage_sqlite_confirm_msg: 'SQLite 无法运行多个 WebUI worker 或 HA。OAuth 与状态仍保存在 state.db。是否继续？',
  storage_sqlite_confirm_btn: '使用 SQLite',
  members_disable_confirm_title: '关闭多用户模式？',
  members_disable_confirm_msg: '这将停用所有成员账户、团队和项目。是否继续？',
  ...
  members_identity_linked: 'OAuth 账号已绑定。',
  members_oauth_err_generic: 'OAuth 绑定失败，请重试。',
  members_oauth_err_token_exchange: 'OAuth 换票失败，请重新绑定。',
  members_oauth_err_bind_failed: '无法绑定该 OAuth 账号。',
  members_oauth_err_missing_claims: 'OAuth 提供商未返回身份信息。',
  members_oauth_err_oauth_denied: '已取消 OAuth 授权。',
  ...
  sign_out: '退出登录',
  settings_label_shutdown: '停止 Intellect WebUI 服务器',
  ...
  settings_shutdown_confirm_title: '停止 Intellect WebUI',
  settings_shutdown_confirm_message: '停止 Intellect WebUI 服务器？',
  ...
  providers_tab_title: '基座模型',
  providers_section_title: '基座模型',
  providers_section_meta: '管理 AI 基座模型的 API 密钥。修改立即生效。',
  ...
  settings_tab_oauth_providers: '认证服务',
  settings_oauth_providers_title: '认证服务',
  settings_oauth_providers_meta: '管理成员登录认证服务（GitHub、Google 等 OAuth 提供商）。',
  oauth_yaml_migration_title: 'config.yaml 中的旧版 OAuth 提供商',
  oauth_yaml_migration_body: 'config.yaml 的 members.oauth.providers 中仍有 {count} 个提供商。提供商配置已迁至 state.db（本页管理）。请在服务器上执行一次性迁移：',
  oauth_yaml_migration_marker_note: '此前已执行过迁移；请在确认后清空 YAML 中的 providers 列表。',
  oauth_providers_add: '+ 添加提供商',
  oauth_providers_add_title: '添加 OAuth 提供商',
  oauth_providers_empty: '未配置 OAuth 提供商。',
  oauth_providers_enabled: '已启用',
  oauth_providers_disabled: '已禁用',
  oauth_providers_builtin: '内置',
  oauth_providers_custom: '自定义',
  oauth_providers_enable: '启用',
  oauth_providers_disable: '禁用',
  oauth_providers_saved: '提供商已保存',
  oauth_providers_create: '创建',
  oauth_providers_created: '提供商已创建',
  oauth_providers_deleted: '提供商已删除',
  oauth_providers_delete_title: '删除 OAuth 提供商',
  oauth_providers_delete_msg: '移除此 OAuth 提供商？此操作不可撤销。',
  oauth_providers_id_name_required: '提供商 ID 和名称为必填项',
  oauth_status_configured: '已配置',
  oauth_status_authenticated: '已认证',
  oauth_status_partial: '配置不完整',
  oauth_status_not_configured: '未配置',
  oauth_tab_login: '登录认证',
  oauth_tab_model: '基座模型',
  oauth_tab_server: '服务认证',
  oauth_field_id: '提供商 ID',
  oauth_field_name: '显示名称',
  oauth_field_auth_flow: '认证流程',
  oauth_field_usage: '用途',
  oauth_field_client_id: 'Client ID',
  oauth_field_client_secret: 'Client Secret',
  oauth_field_authorize_url: '授权端点 URL',
  oauth_field_token_url: 'Token 端点 URL',
  oauth_field_userinfo_url: '用户信息 URL',
  oauth_field_scopes: 'Scopes',
  oauth_field_oidc_discovery_url: 'OIDC 发现 URL',
  oauth_field_device_code_url: '设备码 URL',
  oauth_field_header_name: 'Header 名称',
  oauth_field_map_mode: '映射模式',
  oauth_field_logo: 'Logo',
  oauth_field_logo_hint: '上传 SVG 或 PNG 文件（可选）',
  oauth_flow_pkce_loopback: 'PKCE Loopback',
  oauth_flow_oidc_discovery: 'OIDC Discovery',
  oauth_flow_device_code: 'Device Code',
  oauth_flow_trusted_header: 'Trusted Header',
  ...
  agent_delete_confirm_message: '该配置档的所有会话、配置、技能和记忆将被永久删除。此操作无法撤销。',
  ...
  agents_empty_title: '选择一个 agent',
  profiles_empty_title: '选择一个配置文件',
  agents_empty_sub: '从侧栏选择 agent 以查看和编辑设置，或创建新的。',
  ...
  cron_agent_label: '配置档',
  cron_profile_label: '配置档',
  cron_agent_server_default: '服务器默认',
  cron_profile_server_default: '服务器默认',
  cron_agent_server_default_hint: '运行时使用 WebUI 服务器默认配置档。没有配置档的现有作业会保留此旧行为。',
  ...
  agent_base_url_label: '基础 URL',
  profile_base_url_label: '基础 URL',
  agent_api_key_label: 'API 密钥',
  ...
  wiki_init_btn: '初始化 Wiki',
  wiki_init_confirm_body: '在 {path} 创建标准 LLM Wiki 目录结构？',
  wiki_init_domain_prompt: 'Wiki 领域（可选）：',
  wiki_init_success: 'Wiki 已初始化。',
  wiki_init_failed: 'Wiki 初始化失败。',
  tab_wiki: 'Wiki',
  wiki_catalog_personal: '个人',
  wiki_catalog_teams: '团队',
  wiki_catalog_projects: '项目',
  wiki_catalog_global: '组织',
  wiki_pending_contributions: '待审核',
  wiki_empty_title: '选择 Wiki 作用域',
  wiki_empty_sub: '从侧栏选择个人、团队或项目 Wiki。',
  wiki_missing_wiki_title: 'Wiki 未初始化',
  wiki_missing_wiki_sub: '请先初始化 Wiki 目录结构，再构建 Vault。',
  wiki_no_vault_title: 'Vault 尚未构建',
  wiki_no_vault_sub: 'Wiki 内容已就绪，构建 Quartz Vault 后可在此浏览。',
  wiki_building_title: '正在构建 Vault',
  wiki_building_sub: '正在构建 Vault…',
  wiki_building_eta_note: '估算进度',
  wiki_failed_title: 'Vault 构建失败',
  wiki_failed_unknown: '构建失败。',
  wiki_build_btn: '构建 Vault',
  wiki_rebuild_btn: '重新构建',
  wiki_retry_btn: '重试',
  wiki_view_logs: '查看日志',
  wiki_open_tab: '在新标签页打开',
  wiki_build_queued: 'Vault 构建已排队。',
  wiki_build_failed: '触发 Vault 构建失败。',
  wiki_badge_ready: '就绪',
  wiki_badge_building: '构建中',
  wiki_badge_empty: '空',
  wiki_badge_missing: '缺失',
  wiki_badge_failed: '失败',
  wiki_badge_no_vault: '未构建',
  wiki_status_missing_at: '在 {path} 未找到 LLM Wiki 目录。',
  vault_wiki_settings_title: 'LLM Wiki 与 Vault',
  vault_wiki_settings_desc: '初始化知识库并配置 /vault/ URL 路由方式。',
  vault_wiki_settings_desc_single: '初始化知识库并配置 Vault 重建触发方式。',
  vault_routing_title: 'Vault URL 路由',
  vault_routing_context: '上下文感知',
  vault_routing_context_desc: '访问 /vault/ 时打开当前项目或团队的 wiki。',
  vault_routing_explicit: '仅显式路径',
  vault_routing_explicit_desc: '/vault/ 仅打开全局 wiki；作用域 wiki 需使用 /vault/p/、/vault/t/ 或 /vault/m/。',
  vault_routing_saved: 'Vault 路由已保存。',
  vault_routing_save_failed: '保存 Vault 路由失败。',
  vault_routing_current: 'Vault 路由：{mode}',
  vault_build_trigger_title: '构建触发方式',
  vault_build_trigger_auto: '自动 — 会话结束后 wiki 有变更时重建',
  vault_build_trigger_manual: '手动 — 仅通过按钮或 API 重建',
  vault_build_trigger_scheduled: '定时 — 按 cron 计划重建（需 gateway）',
  vault_build_schedule_label: 'Cron 表达式',
  vault_build_schedule_hint: '5 段 cron，例如 0 * * * * = 每小时',
  vault_scheduler_last: '上次定时运行',
  vault_scheduler_next: '预计下次运行',
  vault_scheduler_gateway_hint: '定时构建需要 intellect gateway 常驻运行。',
  vault_config_saved: 'Vault 设置已保存。',
  ...
  checkpoint_date: '日期',
  checkpoint_diff_files_changed: '變更的檔案',
  ...
  // Memory Provider (System settings)
  memory_provider_title: '记忆体提供者',
  memory_provider_desc: '选择并配置代理的外部记忆体后端。',
  memory_provider_select: '选择提供者',
  memory_provider_builtin: '仅内建 (MEMORY.md + USER.md)',
  memory_provider_active: '使用中',
  memory_provider_inactive: '未配置',
  memory_provider_not_available: '不可用',
  memory_provider_save: '保存配置',
  memory_provider_saved: '记忆体提供者配置已保存。需重启代理以应用变更。',
  memory_provider_save_failed: '配置保存失败。',
  memory_provider_unavailable: '记忆体提供者 API 不可用 (需 intellect-agent)。',
  memory_provider_load_failed: '加载提供者配置失败。',
  memory_provider_no_config: '此提供者没有可配置的选项。',
  memory_provider_secret_set: '(已配置)',
  memory_provider_secret_change: '更改',
  memory_provider_secret_hide: '隐藏',
  memory_provider_restart_hint: '提供者变更需要重启代理才能生效。',
 },
...
path_copied: '\u6a94\u6848\u8def\u5f91\u5df2\u8907\u88fd\u5230\u526a\u8cbc\u7c3f',
 ...
 folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
  ...
  kanban_assignee_agents_label: 'Intellect 設定檔',
  ...
  member_project_banner: '\u8acb\u9078\u64c7\u4e00\u500b\u4f7f\u7528\u4e2d\u7684\u5c08\u6848\u4ee5\u7e7c\u7e8c\u3002',
  teams_panel_desc: '\u52a0\u5165\u5718\u968a\u3001\u9078\u64c7\u4f7f\u7528\u4e2d\u5718\u968a\u3001\u5be9\u6279\u52a0\u5165\u7533\u8acb\u3002',
  teams_group_mine: '\u6211\u7684\u5718\u968a',
  teams_group_manage: '\u5718\u968a\u7ba1\u7406',
  teams_section_mine: '\u6211\u7684\u5718\u968a',
  teams_section_manage: '\u5718\u968a\u7ba1\u7406',
  teams_section_approvals: '\u6210\u54e1\u5be9\u6279',
  teams_manage_empty: '\u66ab\u7121\u5718\u968a\u7ba1\u7406\u64cd\u4f5c\u3002',
  teams_tools: '\u5718\u968a\u5de5\u5177',
  teams_leave: '\u96e2\u958b',
  teams_archive: '\u6b78\u6a94',
  teams_soul_refresh: '\u91cd\u65b0\u6574\u7406 SOUL',
  teams_role_admin: '\u5718\u968a\u7ba1\u7406\u54e1',
  teams_members_manage: '\u5718\u968a\u6210\u54e1',
  teams_no_admin_teams: '\u60a8\u4e0d\u662f\u4efb\u4f55\u5718\u968a\u7684\u7ba1\u7406\u54e1\u3002',
  teams_no_members: '\u66ab\u7121\u6210\u54e1\u3002',
  teams_promote_admin: '\u8a2d\u70ba\u7ba1\u7406\u54e1',
  teams_demote_admin: '\u53d6\u6d88\u7ba1\u7406\u54e1',
  teams_admin_updated: '\u5718\u968a\u89d2\u8272\u5df2\u66f4\u65b0',
  teams_remove_member: '\u79fb\u9664',
  teams_member_removed: '\u6210\u54e1\u5df2\u79fb\u9664',
  teams_open_panel: '\u958b\u555f\u5718\u968a\u9762\u677f',
  tab_projects: '\u5c08\u6848',
  members_project_id: '\u5c08\u6848 ID',
  members_join_project: '\u7533\u8acb\u52a0\u5165',
  projects_open_panel: '\u958b\u555f\u5c08\u6848\u9762\u677f',
  projects_panel_desc: '\u52a0\u5165\u5c08\u6848\u3001\u9078\u64c7\u4f7f\u7528\u4e2d\u5c08\u6848\u3001\u5be9\u6279\u52a0\u5165\u7533\u8acb\u3002',
  projects_group_mine: '\u6211\u7684\u5c08\u6848',
  projects_group_manage: '\u5c08\u6848\u7ba1\u7406',
  projects_section_mine: '\u6211\u7684\u5c08\u6848',
  projects_section_manage: '\u5c08\u6848\u7ba1\u7406',
  projects_section_approvals: '\u6210\u54e1\u5be9\u6279',
  projects_manage_empty: '\u66ab\u7121\u5c08\u6848\u7ba1\u7406\u64cd\u4f5c\u3002',
  projects_tools: '\u5c08\u6848\u5de5\u5177',
  projects_leave: '\u96e2\u958b',
  projects_archive: '\u6b78\u6a94',
  projects_archived: '\u5c08\u6848\u5df2\u6b78\u6a94',
  projects_left: '\u5df2\u96e2\u958b\u5c08\u6848',
  projects_disabled_members: '\u8acb\u5148\u5728 config.yaml \u555f\u7528 members.enabled\u3002',
  projects_disabled_projects: '\u8acb\u5148\u5728 config.yaml \u555f\u7528 members.projects.enabled\u3002',
  projects_sign_in_first: '\u8acb\u5148\u767b\u5165\u4ee5\u7ba1\u7406\u5c08\u6848\u3002',
  projects_multi_banner: '\u8acb\u5728\u5e33\u6236\u9078\u55ae\u4e2d\u9078\u64c7\u4f7f\u7528\u4e2d\u5c08\u6848\u3002',
  projects_my_projects: '\u6211\u7684\u5c08\u6848',
  projects_no_memberships: '\u5c1a\u672a\u52a0\u5165\u4efb\u4f55\u5c08\u6848\u3002',
  projects_active: '\u7576\u524d',
  projects_use: '\u4f7f\u7528',
  projects_join: '\u52a0\u5165\u5c08\u6848',
  projects_create: '\u5efa\u7acb\u5c08\u6848',
  projects_display_name: '\u986f\u793a\u540d\u7a31',
  projects_no_pending: '\u66ab\u7121\u5f85\u5be9\u6279\u7684\u52a0\u5165\u7533\u8acb\u3002',
  projects_approve: '\u6838\u51c6',
  projects_reject: '\u62d2\u7d55',
  projects_active_set: '\u5df2\u66f4\u65b0\u4f7f\u7528\u4e2d\u5c08\u6848',
  projects_created: '\u5c08\u6848\u5df2\u5efa\u7acb',
  projects_approved: '\u5df2\u6838\u51c6\u6210\u54e1',
  projects_rejected: '\u5df2\u62d2\u7d55\u7533\u8acb',
  projects_role_admin: '\u5c08\u6848\u7ba1\u7406\u54e1',
  projects_members_manage: '\u5c08\u6848\u6210\u54e1',
  projects_no_admin_projects: '\u60a8\u4e0d\u662f\u4efb\u4f55\u5c08\u6848\u7684\u7ba1\u7406\u54e1\u3002',
  projects_no_members: '\u66ab\u7121\u6210\u54e1\u3002',
  projects_promote_admin: '\u8a2d\u70ba\u7ba1\u7406\u54e1',
  projects_demote_admin: '\u53d6\u6d88\u7ba1\u7406\u54e1',
  projects_admin_updated: '\u5c08\u6848\u89d2\u8272\u5df2\u66f4\u65b0',
  projects_remove_member: '\u79fb\u9664',
  projects_member_removed: '\u6210\u54e1\u5df2\u79fb\u9664',
  projects_soul_edit: '\u5c08\u6848 SOUL',
  projects_soul_load: '\u8f09\u5165',
  projects_soul_save: '\u5132\u5b58 SOUL',
  projects_soul_saved: 'SOUL \u5df2\u5132\u5b58',
  projects_link_teams: '\u95dc\u806f\u5718\u968a',
  projects_link_team: '\u95dc\u806f\u5718\u968a',
  projects_unlink_team: '\u53d6\u6d88\u95dc\u806f',
  projects_team_linked: '\u5718\u968a\u5df2\u95dc\u806f',
  projects_team_unlinked: '\u5df2\u53d6\u6d88\u95dc\u806f',
  projects_no_linked_teams: '\u66ab\u7121\u95dc\u806f\u5718\u968a\u3002',
  member_projects: '\u5c08\u6848',
  projects_load_failed: '\u7121\u6cd5\u8f09\u5165\u5c08\u6848\u9762\u677f\u3002',
  members_setup_title: '\u6210\u54e1\u8207 OAuth',
  members_setup_desc: '多使用者模式使用 intellect-agent 成員資料庫。',
  ...
  onboarding_api_key_label_optional: 'API 金鑰（可選）',
  onboarding_api_key_placeholder_optional: '無金鑰伺服器請留空',
  onboarding_api_key_help_keyless: '大多數 LM Studio / Ollama / vLLM 安裝預設無金鑰 — 若伺服器不需要認證請留空。使用「測試連線」按鈕驗證。',
  onboarding_back: '\u4e0a\u4e00\u6b65',
  ...
  onboarding_probe_ok: '已連線。可用 {n} 個模型。',
  onboarding_probe_error_generic: '無法連線到設定的基礎 URL。',
  onboarding_probe_error_invalid_url: '基礎 URL 必須以 http:// 或 https:// 開頭。',
  onboarding_probe_error_dns: '無法解析主機名稱。請檢查 URL 或使用主機的 IP 位址。',
  onboarding_probe_error_connect_refused: '連線被拒絕 — 伺服器可能未在該位址執行。若在 Docker 內，請嘗試使用主機 IP 而非 localhost。',
  onboarding_probe_error_timeout: '端點未及時回應。請檢查伺服器是否執行中且 URL 正確。',
  onboarding_probe_error_http_4xx: '端點回傳客戶端錯誤。請檢查認證資訊及 URL 路徑（通常以 /v1 結尾）。',
  onboarding_probe_error_http_5xx: '端點回傳伺服器錯誤。請檢查 LM Studio / Ollama 伺服器日誌。',
  onboarding_probe_error_parse: '端點未以預期格式回傳模型列表。請確認 URL 指向 OpenAI 相容 API 根路徑。',
  onboarding_probe_error_unreachable: '無法連線到設定的基礎 URL。',
  ...
  oauth_codex_step1: '步驟 1：造訪此 URL 並輸入代碼',
  ...
  session_toolsets_desc: '限制此會話的可用工具（空白 = 使用全域設定）',
  ...
  session_toolsets_failed: '無法更新工具集：',
  ...
  agent_created: (name) => `設定檔 ${name} 已建立`,
  profile_created: (name) => `設定檔 ${name} 已建立`,
  agent_default_label: '(default)',
  profile_default_label: '\uff08\u9810\u8a2d\uff09',
  agent_delete_confirm_title: (name) => `刪除設定檔「${name}」？`,
  profile_delete_confirm_title: (name) => `刪除設定檔「${name}」？`,
  agent_deleted: (name) => `設定檔 ${name} 已刪除`,
  ...
  // Profiles
  agents_empty_title: '尚無設定檔',
  profiles_empty_title: '尚無設定檔',
  agents_empty_sub: '建立設定檔以快速切換環境',
  ...
  cron_agent_label: '設定檔',
  cron_profile_label: '設定檔',
  cron_agent_server_default: '伺服器預設',
  cron_profile_server_default: '伺服器預設',
  cron_agent_server_default_hint: '執行時使用 WebUI 伺服器預設設定檔。沒有設定檔的既有工作會保留此舊行為。',
  ...
  checkpoint_date: '日期',
  checkpoint_diff_files_changed: '變更的檔案',
  checkpoint_diff_no_changes: '此檢查點無變更',
  checkpoint_diff_title: '檢查點差異',
  checkpoint_empty: '尚無檢查點',
  checkpoint_error: '檢查點錯誤',
  checkpoint_files: '檔案',
  checkpoint_loading: '載入檢查點中…',
  checkpoint_message: '訊息',
  checkpoint_restore: '還原',
  checkpoint_restore_confirm_message: '確定要還原至此檢查點？目前的變更將會遺失。',
  checkpoint_restore_confirm_title: '確認還原',
  ...
  insights_model_share: 'Share',
  insights_no_usage_data: 'No usage data yet',
  insights_footer: '基於本機會話資料的洞察',
  insights_input_tokens: '輸入 Token',
  insights_messages: '訊息',
  insights_models: '模型',
  insights_no_cost: '無成本資料',
  insights_output_tokens: '輸出 Token',
  insights_peak_hour: '尖峰時段',
  insights_sessions: '會話',
  insights_title: '洞察',
  insights_token_breakdown: 'Token 分佈',
  insights_tokens: 'Token',
  insights_total: '總計',
  settings_desc_api_redact: '在日誌中遮蔽 API 金鑰與權杖',
  settings_label_api_redact: 'API 金鑰編輯',
  voice_error: 'Voice not supported in this browser',
  voice_listening: 'Listening…',
  voice_mode_active: 'Voice mode on',
  voice_mode_off: 'Voice mode off',
  ...
  voice_mode_toggle: 'Voice mode',
  voice_mode_toggle_active: 'Exit voice mode',
  subagent_children: '子代理',
  // Memory Provider (System settings)
  memory_provider_title: '記憶體提供者',
  memory_provider_desc: '選擇並設定代理的外部記憶體後端。',
  memory_provider_select: '選擇提供者',
  memory_provider_builtin: '僅內建 (MEMORY.md + USER.md)',
  memory_provider_active: '使用中',
  memory_provider_inactive: '未設定',
  memory_provider_not_available: '不可用',
  memory_provider_save: '儲存設定',
  memory_provider_saved: '記憶體提供者設定已儲存。需重啟代理以套用變更。',
  memory_provider_save_failed: '設定儲存失敗。',
  memory_provider_unavailable: '記憶體提供者 API 不可用 (需 intellect-agent)。',
  memory_provider_load_failed: '載入提供者設定失敗。',
  memory_provider_no_config: '此提供者沒有可設定的選項。',
  memory_provider_secret_set: '(已設定)',
  memory_provider_secret_change: '更改',
  memory_provider_secret_hide: '隱藏',
  memory_provider_restart_hint: '提供者變更需要重啟代理才能生效。',
 },
...
path_copied: 'Percorso file copiato negli appunti',
 ...
 folder_add_as_space_title: 'Aggiungere come Spazio?',
  ...
  settings_plugins_title: '插件',
  settings_plugins_meta: '檢視已安裝的 Intellect 插件及其註冊的生命週期掛鉤。此面板為唯讀。',
  settings_plugins_empty: '目前沒有可見的 Intellect 插件。請從 Intellect CLI/設定檔安裝或啟用插件以在此處檢視。',
  plugins_unnamed: '未命名插件',
  plugins_no_description: '未提供描述。',
  plugins_no_hooks: '無已註冊的生命週期掛鉤',
  plugins_registered_hooks: '已註冊的掛鉤',
  plugins_enabled: '已啟用',
  plugins_disabled: '已停用',
  plugins_active_provider: '使用中（供應商）',
  plugins_provider_no_hooks: '供應商插件 — 無代理可見掛鉤',
  plugins_load_failed: '無法載入插件：',
  ...
  agents_empty_title: 'Seleziona un profilo',
  profiles_empty_title: 'Seleziona un profilo',
  agents_empty_sub: 'Scegli un profilo agente dalla sidebar per vedere e modificare le sue impostazioni, o creane uno nuovo.',
  ...
  agents_no_agents: 'Nessun profilo trovato.',
  ...
  manage_agents: 'Gestisci profili',
  manage_profiles: 'Gestisci profili',
  agents_load_failed: 'Caricamento profili fallito',
  ...
  agent_delete_confirm_message: 'Tutte le sessioni, configurazioni, skill e memoria per questo profilo saranno eliminate permanentemente. Questa azione non può essere annullata.',
  ...
  // ── Profile / Teams / Projects (it) ──
  profile_save_username: 'Salva nome utente',
  profile_save_password: 'Salva password',
  profile_local_user: 'Utente locale',
  profile_team_none: 'Nessun team selezionato',
  profile_username_required: 'Il nome utente è obbligatorio',
  profile_username_saved: 'Nome utente salvato',
  profile_password_required: 'Inserisci una password',
  profile_avatar_removed: 'Avatar rimosso',
  profile_avatar_saved: 'Avatar aggiornato',
  profile_avatar_type_error: 'Usa JPEG, PNG o WebP',
  profile_avatar_size_error: 'L\'avatar deve essere di 512 KB o meno',
  profile_save_failed: 'Salvataggio non riuscito: ',
  unlink: 'Scollega',
  revoke: 'Revoca',
  teams_panel_desc: 'Unisciti ai team, scegli quello attivo e approva le richieste.',
  teams_group_mine: 'I miei team',
  teams_group_manage: 'Gestione team',
  teams_section_mine: 'I miei team',
  teams_section_manage: 'Gestione team',
  teams_section_approvals: 'Approvazioni membri',
  teams_manage_empty: 'Nessuna azione di gestione team disponibile.',
  teams_tools: 'Strumenti team',
  teams_leave: 'Esci',
  teams_archive: 'Archivia',
  teams_soul_refresh: 'Aggiorna SOUL',
  teams_soul_refreshed: 'SOUL aggiornato',
  teams_archived: 'Team archiviato',
  teams_left: 'Hai lasciato il team',
  teams_disabled_members: 'Abilita prima members.enabled in config.yaml.',
  teams_disabled_teams: 'Abilita members.teams.enabled in config.yaml.',
  teams_sign_in_first: 'Accedi per gestire i team.',
  teams_multi_banner: 'Seleziona un team attivo dal menu account.',
  teams_my_teams: 'I miei team',
  teams_no_memberships: 'Non fai ancora parte di nessun team.',
  teams_active: 'Attivo',
  teams_use: 'Usa',
  teams_join: 'Unisciti a un team',
  teams_create: 'Crea team',
  teams_display_name: 'Nome visualizzato',
  teams_admin: 'Admin',
  teams_no_pending: 'Nessuna richiesta di adesione in sospeso.',
  teams_approve: 'Approva',
  teams_reject: 'Rifiuta',
  teams_active_set: 'Team attivo aggiornato',
  teams_context_refreshed: 'Team attivo aggiornato — chat aggiornata.',
  teams_created: 'Team creato',
  teams_approved: 'Membro approvato',
  teams_rejected: 'Richiesta rifiutata',
  teams_role_admin: 'Amministratore del team',
  teams_members_manage: 'Membri del team',
  teams_no_admin_teams: 'Non sei amministratore di nessun team.',
  teams_no_members: 'Nessun membro.',
  teams_promote_admin: 'Rendi amministratore',
  teams_demote_admin: 'Rimuovi amministratore',
  teams_admin_updated: 'Ruolo del team aggiornato',
  teams_remove_member: 'Rimuovi',
  teams_member_removed: 'Membro rimosso',
  teams_open_panel: 'Apri pannello team',
  projects_open_panel: 'Apri pannello progetti',
  projects_panel_desc: 'Unisciti ai progetti, scegli quello attivo e approva le richieste.',
  projects_group_mine: 'I miei progetti',
  projects_group_manage: 'Gestione progetti',
  projects_section_mine: 'I miei progetti',
  projects_section_manage: 'Gestione progetti',
  projects_section_approvals: 'Approvazioni membri',
  projects_manage_empty: 'Nessuna azione di gestione progetti disponibile.',
  projects_tools: 'Strumenti progetto',
  projects_leave: 'Esci',
  projects_archive: 'Archivia',
  projects_archived: 'Progetto archiviato',
  projects_left: 'Hai lasciato il progetto',
  projects_disabled_members: 'Abilita prima members.enabled in config.yaml.',
  projects_disabled_projects: 'Abilita members.projects.enabled in config.yaml.',
  projects_sign_in_first: 'Accedi per gestire i progetti.',
  projects_multi_banner: 'Seleziona un progetto attivo dal menu account.',
  projects_my_projects: 'I miei progetti',
  projects_no_memberships: 'Non fai ancora parte di nessun progetto.',
  projects_active: 'Attivo',
  projects_use: 'Usa',
  projects_join: 'Unisciti a un progetto',
  projects_create: 'Crea progetto',
  projects_display_name: 'Nome visualizzato',
  projects_no_pending: 'Nessuna richiesta di adesione in sospeso.',
  projects_approve: 'Approva',
  projects_reject: 'Rifiuta',
  projects_active_set: 'Progetto attivo aggiornato',
  projects_created: 'Progetto creato',
  projects_approved: 'Membro approvato',
  projects_rejected: 'Richiesta rifiutata',
  projects_role_admin: 'Amministratore del progetto',
  projects_members_manage: 'Membri del progetto',
  projects_no_admin_projects: 'Non sei amministratore di nessun progetto.',
  projects_no_members: 'Nessun membro.',
  projects_promote_admin: 'Rendi amministratore',
  projects_demote_admin: 'Rimuovi amministratore',
  projects_admin_updated: 'Ruolo del progetto aggiornato',
  projects_remove_member: 'Rimuovi',
  projects_member_removed: 'Membro rimosso',
  projects_soul_edit: 'SOUL del progetto',
  projects_soul_load: 'Carica',
  projects_soul_save: 'Salva SOUL',
  projects_soul_saved: 'SOUL salvato',
  projects_link_teams: 'Team collegati',
  projects_link_team: 'Collega team',
  projects_unlink_team: 'Scollega',
  projects_team_linked: 'Team collegato',
  projects_team_unlinked: 'Team scollegato',
  projects_no_linked_teams: 'Nessun team collegato.',
  member_projects: 'Progetti',
  projects_load_failed: 'Impossibile caricare il pannello progetti.',
  // ── Checkpoints / Rollback ──
...
path_copied: 'ファイルパスをクリップボードにコピーしました',
 ...
 folder_add_as_space_title: 'スペースとして追加?',
  ...
  kanban_assignee_agents_label: 'Intellect プロファイル',
  ...
  agents_empty_title: 'プロファイルを選択',
  profiles_empty_title: 'プロファイルを選択',
  agents_empty_sub: 'サイドバーからエージェントプロファイルを選んで設定を表示・編集するか、新規作成してください。',
  ...
  agent_name_rule: '小文字、数字、ハイフン、アンダースコアのみ',
  profile_name_rule: '小文字、数字、ハイフン、アンダースコアのみ',
  agent_base_url_rule: 'ベース URL は http:// または https:// で始める必要があります',
  ...
  agent_delete_confirm_message: 'このプロファイルのすべてのセッション、設定、スキル、メモリが完全に削除されます。この操作は取り消せません。',
  ...
  cron_agent_label: 'プロフィール',
  cron_profile_label: 'プロフィール',
  cron_agent_server_default: 'サーバーデフォルト',
  cron_profile_server_default: 'サーバーデフォルト',
  cron_agent_server_default_hint: '実行時に WebUI サーバーのデフォルトプロフィールを使用します。プロフィールのない既存ジョブはこの従来の動作を維持します。',
  ...
  agent_base_url_label: 'ベース URL',
  profile_base_url_label: 'ベース URL',
  agent_api_key_label: 'APIキー',
  ...
  // ── Profile / Teams / Projects (ja) ──
  profile_save_username: 'ユーザー名を保存',
  profile_save_password: 'パスワードを保存',
  profile_local_user: 'ローカルユーザー',
  profile_team_none: 'チーム未選択',
  profile_username_required: 'ユーザー名は必須です',
  profile_username_saved: 'ユーザー名を保存しました',
  profile_password_required: 'パスワードを入力してください',
  profile_avatar_removed: 'アバターを削除しました',
  profile_avatar_saved: 'アバターを更新しました',
  profile_avatar_type_error: 'JPEG、PNG、WebP を使用してください',
  profile_avatar_size_error: 'アバターは 512KB 以下である必要があります',
  profile_save_failed: '保存に失敗しました: ',
  unlink: 'リンク解除',
  revoke: '取り消し',
  teams_panel_desc: 'チームに参加し、アクティブチームを選択し、リクエストを承認します。',
  teams_group_mine: 'マイチーム',
  teams_group_manage: 'チーム管理',
  teams_section_mine: 'マイチーム',
  teams_section_manage: 'チーム管理',
  teams_section_approvals: 'メンバー承認',
  teams_manage_empty: 'チーム管理操作はありません。',
  teams_tools: 'チームツール',
  teams_leave: '退出',
  teams_archive: 'アーカイブ',
  teams_soul_refresh: 'SOUL を更新',
  teams_soul_refreshed: 'SOUL を更新しました',
  teams_archived: 'チームをアーカイブしました',
  teams_left: 'チームを退出しました',
  teams_disabled_members: '先に config.yaml で members.enabled を有効にしてください。',
  teams_disabled_teams: '先に config.yaml で members.teams.enabled を有効にしてください。',
  teams_sign_in_first: 'チーム管理にはサインインが必要です。',
  teams_multi_banner: 'アカウントメニューからアクティブチームを選択してください。',
  teams_my_teams: 'マイチーム',
  teams_no_memberships: 'まだチームに参加していません。',
  teams_active: 'アクティブ',
  teams_use: '使用',
  teams_join: 'チームに参加',
  teams_create: 'チームを作成',
  teams_display_name: '表示名',
  teams_admin: '管理',
  teams_no_pending: '保留中の参加リクエストはありません。',
  teams_approve: '承認',
  teams_reject: '拒否',
  teams_active_set: 'アクティブチームを更新しました',
  teams_context_refreshed: 'アクティブチームを更新 — チャットを更新しました。',
  teams_created: 'チームを作成しました',
  teams_approved: 'メンバーを承認しました',
  teams_rejected: 'リクエストを拒否しました',
  teams_role_admin: 'チーム管理者',
  teams_members_manage: 'チームメンバー',
  teams_no_admin_teams: '管理者であるチームはありません。',
  teams_no_members: 'メンバーはいません。',
  teams_promote_admin: '管理者にする',
  teams_demote_admin: '管理者を解除',
  teams_admin_updated: 'チームの役割を更新しました',
  teams_remove_member: '削除',
  teams_member_removed: 'メンバーを削除しました',
  teams_open_panel: 'チームパネルを開く',
  projects_open_panel: 'プロジェクトパネルを開く',
  projects_panel_desc: 'プロジェクトに参加し、アクティブプロジェクトを選択し、リクエストを承認します。',
  projects_group_mine: 'マイプロジェクト',
  projects_group_manage: 'プロジェクト管理',
  projects_section_mine: 'マイプロジェクト',
  projects_section_manage: 'プロジェクト管理',
  projects_section_approvals: 'メンバー承認',
  projects_manage_empty: 'プロジェクト管理操作はありません。',
  projects_tools: 'プロジェクトツール',
  projects_leave: '退出',
  projects_archive: 'アーカイブ',
  projects_archived: 'プロジェクトをアーカイブしました',
  projects_left: 'プロジェクトを退出しました',
  projects_disabled_members: '先に config.yaml で members.enabled を有効にしてください。',
  projects_disabled_projects: '先に config.yaml で members.projects.enabled を有効にしてください。',
  projects_sign_in_first: 'プロジェクト管理にはサインインが必要です。',
  projects_multi_banner: 'アカウントメニューからアクティブプロジェクトを選択してください。',
  projects_my_projects: 'マイプロジェクト',
  projects_no_memberships: 'まだプロジェクトに参加していません。',
  projects_active: 'アクティブ',
  projects_use: '使用',
  projects_join: 'プロジェクトに参加',
  projects_create: 'プロジェクトを作成',
  projects_display_name: '表示名',
  projects_no_pending: '保留中の参加リクエストはありません。',
  projects_approve: '承認',
  projects_reject: '拒否',
  projects_active_set: 'アクティブプロジェクトを更新しました',
  projects_created: 'プロジェクトを作成しました',
  projects_approved: 'メンバーを承認しました',
  projects_rejected: 'リクエストを拒否しました',
  projects_role_admin: 'プロジェクト管理者',
  projects_members_manage: 'プロジェクトメンバー',
  projects_no_admin_projects: '管理者であるプロジェクトはありません。',
  projects_no_members: 'メンバーはいません。',
  projects_promote_admin: '管理者にする',
  projects_demote_admin: '管理者を解除',
  projects_admin_updated: 'プロジェクトの役割を更新しました',
  projects_remove_member: '削除',
  projects_member_removed: 'メンバーを削除しました',
  projects_soul_edit: 'プロジェクト SOUL',
  projects_soul_load: '読み込み',
  projects_soul_save: 'SOUL を保存',
  projects_soul_saved: 'SOUL を保存しました',
  projects_link_teams: 'リンク済みチーム',
  projects_link_team: 'チームをリンク',
  projects_unlink_team: 'リンク解除',
  projects_team_linked: 'チームをリンクしました',
  projects_team_unlinked: 'チームのリンクを解除しました',
  projects_no_linked_teams: 'リンク済みチームはありません。',
  member_projects: 'プロジェクト',
  projects_load_failed: 'プロジェクトパネルを読み込めませんでした。',
  // ── Checkpoints / Rollback ──
...
path_copied: 'Путь к файлу скопирован в буфер обмена',
 ...
 folder_add_as_space_title: 'Добавить как пространство?',
  ...
  kanban_assignee_agents_label: 'Профили Intellect',
  ...
  logs_file: '檔案',
  logs_tail: '結尾',
  logs_auto_refresh: '自動重新整理（5 秒）',
  logs_wrap: '換行',
  logs_copy_all: '全部複製',
  logs_empty: '尚無日誌行。',
  logs_loading: '正在載入日誌…',
  logs_load_failed: '日誌載入失敗',
  logs_status_idle: '選擇日誌檔案以檢視最近的行。',
  logs_no_mtime: '尚未寫入',
  logs_truncated_hint: '顯示大型日誌檔案的尾部；已略過較早的位元組以保持記憶體受限。',
  logs_copied: '日誌已複製',
  ...
  agent_use: 'Использовать',
  profile_use: 'Использовать',
  agent_switch_title: 'Переключиться на этот профиль',
  profile_switch_title: 'Переключиться на этот профиль',
  agent_delete_title: 'Удалить этот профиль',
  profile_delete_title: 'Удалить этот профиль',
  agent_default_label: '(по умолчанию)',
  profile_default_label: '(по умолчанию)',
  agent_name_placeholder: 'Название профиля (строчные буквы, a-z, 0-9, дефисы)',
  profile_name_placeholder: 'Название профиля (строчные буквы, a-z, 0-9, дефисы)',
  agent_clone_label: 'Скопировать конфигурацию из активного профиля',
  profile_clone_label: 'Скопировать конфигурацию из активного профиля',
  agent_model_label: 'Модель / провайдер',
  profile_model_label: 'Модель / провайдер',
  agent_model_hint: 'Выберите настроенного провайдера и модель для этого нового профиля.',
  profile_model_hint: 'Выберите настроенного провайдера и модель для этого нового профиля.',
  agent_model_use_default: 'Использовать значение активного профиля',
  profile_model_use_default: 'Использовать значение активного профиля',
  agent_base_url_placeholder: 'Базовый URL (необязательно, например http://localhost:11434)',
  profile_base_url_placeholder: 'Базовый URL (необязательно, например http://localhost:11434)',
  agent_api_key_placeholder: 'API-ключ (необязательно)',
  profile_api_key_placeholder: 'API-ключ (необязательно)',
  manage_agents: 'Управление профилями',
  manage_profiles: 'Управление профилями',
  agents_load_failed: 'Не удалось загрузить профили',
  ...
  agent_name_rule: 'Только строчные буквы, цифры, дефисы и подчёркивания',
  profile_name_rule: 'Только строчные буквы, цифры, дефисы и подчёркивания',
  agent_base_url_rule: 'Базовый URL должен начинаться с http:// или https://',
  ...
  agent_delete_confirm_message: 'Все сеансы, конфигурация, навыки и память этого профиля будут удалены безвозвратно. Это действие невозможно отменить.',
  ...
  agents_empty_title: 'Выберите профиль',
  profiles_empty_title: 'Выберите профиль',
  agents_empty_sub: 'Выберите профиль агента на боковой панели, чтобы просмотреть и изменить его настройки, или создайте новый.',
  ...
  cron_agent_label: 'Профиль',
  cron_profile_label: 'Профиль',
  cron_agent_server_default: 'по умолчанию сервера',
  cron_profile_server_default: 'по умолчанию сервера',
  cron_agent_server_default_hint: 'Использует профиль WebUI-сервера по умолчанию во время запуска. Существующие задания без профиля сохраняют это поведение.',
  ...
  // profile form
  agent_name_label: 'Имя',
  profile_name_label: 'Имя',
  agent_base_url_label: 'Базовый URL',
  profile_base_url_label: 'Базовый URL',
  agent_api_key_label: 'API-ключ',
  ...
  // ── Profile / Teams / Projects (ru) ──
  profile_save_username: 'Сохранить имя пользователя',
  profile_save_password: 'Сохранить пароль',
  profile_local_user: 'Локальный пользователь',
  profile_team_none: 'Команда не выбрана',
  profile_username_required: 'Требуется имя пользователя',
  profile_username_saved: 'Имя пользователя сохранено',
  profile_password_required: 'Введите пароль',
  profile_avatar_removed: 'Аватар удалён',
  profile_avatar_saved: 'Аватар обновлён',
  profile_avatar_type_error: 'Используйте JPEG, PNG или WebP',
  profile_avatar_size_error: 'Аватар должен быть не больше 512 КБ',
  profile_save_failed: 'Ошибка сохранения: ',
  unlink: 'Отвязать',
  revoke: 'Отозвать',
  teams_panel_desc: 'Присоединяйтесь к командам, выбирайте активную и одобряйте запросы.',
  teams_group_mine: 'Мои команды',
  teams_group_manage: 'Управление командами',
  teams_section_mine: 'Мои команды',
  teams_section_manage: 'Управление командами',
  teams_section_approvals: 'Одобрение участников',
  teams_manage_empty: 'Нет действий по управлению командами.',
  teams_tools: 'Инструменты команды',
  teams_leave: 'Выйти',
  teams_archive: 'Архивировать',
  teams_soul_refresh: 'Обновить SOUL',
  teams_soul_refreshed: 'SOUL обновлён',
  teams_archived: 'Команда архивирована',
  teams_left: 'Вы вышли из команды',
  teams_disabled_members: 'Сначала включите members.enabled в config.yaml.',
  teams_disabled_teams: 'Сначала включите members.teams.enabled в config.yaml.',
  teams_sign_in_first: 'Войдите, чтобы управлять командами.',
  teams_multi_banner: 'Выберите активную команду в меню аккаунта.',
  teams_my_teams: 'Мои команды',
  teams_no_memberships: 'Вы ещё не состоите ни в одной команде.',
  teams_active: 'Активная',
  teams_use: 'Использовать',
  teams_join: 'Присоединиться к команде',
  teams_create: 'Создать команду',
  teams_display_name: 'Отображаемое имя',
  teams_admin: 'Админ',
  teams_no_pending: 'Нет ожидающих запросов на вступление.',
  teams_approve: 'Одобрить',
  teams_reject: 'Отклонить',
  teams_active_set: 'Активная команда обновлена',
  teams_context_refreshed: 'Активная команда обновлена — чат обновлён.',
  teams_created: 'Команда создана',
  teams_approved: 'Участник одобрен',
  teams_rejected: 'Запрос отклонён',
  teams_role_admin: 'Администратор команды',
  teams_members_manage: 'Участники команды',
  teams_no_admin_teams: 'Вы не администратор ни одной команды.',
  teams_no_members: 'Нет участников.',
  teams_promote_admin: 'Сделать администратором',
  teams_demote_admin: 'Снять администратора',
  teams_admin_updated: 'Роль в команде обновлена',
  teams_remove_member: 'Удалить',
  teams_member_removed: 'Участник удалён',
  teams_open_panel: 'Открыть панель команд',
  projects_open_panel: 'Открыть панель проектов',
  projects_panel_desc: 'Присоединяйтесь к проектам, выбирайте активный и одобряйте запросы.',
  projects_group_mine: 'Мои проекты',
  projects_group_manage: 'Управление проектами',
  projects_section_mine: 'Мои проекты',
  projects_section_manage: 'Управление проектами',
  projects_section_approvals: 'Одобрение участников',
  projects_manage_empty: 'Нет действий по управлению проектами.',
  projects_tools: 'Инструменты проекта',
  projects_leave: 'Выйти',
  projects_archive: 'Архивировать',
  projects_archived: 'Проект архивирован',
  projects_left: 'Вы вышли из проекта',
  projects_disabled_members: 'Сначала включите members.enabled в config.yaml.',
  projects_disabled_projects: 'Сначала включите members.projects.enabled в config.yaml.',
  projects_sign_in_first: 'Войдите, чтобы управлять проектами.',
  projects_multi_banner: 'Выберите активный проект в меню аккаунта.',
  projects_my_projects: 'Мои проекты',
  projects_no_memberships: 'Вы ещё не состоите ни в одном проекте.',
  projects_active: 'Активный',
  projects_use: 'Использовать',
  projects_join: 'Присоединиться к проекту',
  projects_create: 'Создать проект',
  projects_display_name: 'Отображаемое имя',
  projects_no_pending: 'Нет ожидающих запросов на вступление.',
  projects_approve: 'Одобрить',
  projects_reject: 'Отклонить',
  projects_active_set: 'Активный проект обновлён',
  projects_created: 'Проект создан',
  projects_approved: 'Участник одобрен',
  projects_rejected: 'Запрос отклонён',
  projects_role_admin: 'Администратор проекта',
  projects_members_manage: 'Участники проекта',
  projects_no_admin_projects: 'Вы не администратор ни одного проекта.',
  projects_no_members: 'Нет участников.',
  projects_promote_admin: 'Сделать администратором',
  projects_demote_admin: 'Снять администратора',
  projects_admin_updated: 'Роль в проекте обновлена',
  projects_remove_member: 'Удалить',
  projects_member_removed: 'Участник удалён',
  projects_soul_edit: 'SOUL проекта',
  projects_soul_load: 'Загрузить',
  projects_soul_save: 'Сохранить SOUL',
  projects_soul_saved: 'SOUL сохранён',
  projects_link_teams: 'Связанные команды',
  projects_link_team: 'Связать команду',
  projects_unlink_team: 'Отвязать',
  projects_team_linked: 'Команда связана',
  projects_team_unlinked: 'Команда отвязана',
  projects_no_linked_teams: 'Нет связанных команд.',
  member_projects: 'Проекты',
  projects_load_failed: 'Не удалось загрузить панель проектов.',
  checkpoint_date: '日期',
  checkpoint_diff_files_changed: '變更的檔案',
  checkpoint_diff_no_changes: '此檢查點無變更',
  checkpoint_diff_title: '檢查點差異',
...
path_copied: 'Ruta del archivo copiada al portapapeles',
 ...
 folder_add_as_space_title: '¿Añadir como espacio?',
  ...
  workspaces_empty_title: 'Select a space',
  workspaces_empty_sub: 'Pick a space from the sidebar to view its files and settings, or add a new one.',
  agents_empty_title: 'Select a profile',
  profiles_empty_title: 'Select a profile',
  agents_empty_sub: 'Pick an agent profile from the sidebar to view and edit its settings, or create a new one.',
  profiles_empty_sub: 'Pick an agent profile from the sidebar to view and edit its settings, or create a new one.',
  memory_notes_label: 'memory (notes)',
  memory_saved: 'Memory saved',
  my_notes: 'My Notes',
  ...
  discard_file_edits_message: 'Switching workspaces will discard unsaved file edits in the preview.',
  workspace_switched_to: (name) => `Switched to ${name}`,
  agents_no_agents: 'No profiles found.',
  profiles_no_profiles: 'No profiles found.',
  agent_api_keys_configured: 'API keys configured',
  profile_api_keys_configured: 'API keys configured',
  agent_gateway_running: 'Gateway running',
  ...
  agent_name_placeholder: 'Nombre del perfil (minúsculas, a-z, 0-9, guiones)',
  profile_name_placeholder: 'Nombre del perfil (minúsculas, a-z, 0-9, guiones)',
  agent_clone_label: 'Clonar configuración del perfil activo',
  ...
  manage_agents: 'Manage profiles',
  manage_profiles: 'Manage profiles',
  agents_load_failed: 'Failed to load profiles',
  profiles_load_failed: 'Failed to load profiles',
  agent_switched_new_conversation: (name) => `Switched to agent: ${name} — new conversation started`,
  profile_switched_new_conversation: (name) => `Switched to profile: ${name} — new conversation started`,
  agent_switched: (name) => `Switched to agent: ${name}`,
  ...
  agent_delete_confirm_title: (name) => `Delete agent "${name}"?`,
  profile_delete_confirm_title: (name) => `Delete profile "${name}"?`,
  agent_delete_confirm_message: 'Todas las sesiones, configuración, habilidades y memoria de este perfil se eliminarán de forma permanente. Esta acción no se puede deshacer.',
  ...
  cron_agent_server_default_hint: 'Usa el perfil predeterminado del servidor WebUI durante la ejecución. Los trabajos existentes sin perfil conservan este comportamiento heredado.',
  ...
  // ── Profile / Teams / Projects (es) ──
  profile_save_username: 'Guardar nombre de usuario',
  profile_save_password: 'Guardar contraseña',
  profile_local_user: 'Usuario local',
  profile_team_none: 'Ningún equipo seleccionado',
  profile_username_required: 'El nombre de usuario es obligatorio',
  profile_username_saved: 'Nombre de usuario guardado',
  profile_password_required: 'Introduce una contraseña',
  profile_avatar_removed: 'Avatar eliminado',
  profile_avatar_saved: 'Avatar actualizado',
  profile_avatar_type_error: 'Usa JPEG, PNG o WebP',
  profile_avatar_size_error: 'El avatar debe ser de 512 KB o menos',
  profile_save_failed: 'Error al guardar: ',
  unlink: 'Desvincular',
  revoke: 'Revocar',
  teams_panel_desc: 'Únete a equipos, elige uno activo y aprueba solicitudes.',
  teams_group_mine: 'Mis equipos',
  teams_group_manage: 'Gestión de equipos',
  teams_section_mine: 'Mis equipos',
  teams_section_manage: 'Gestión de equipos',
  teams_section_approvals: 'Aprobaciones de miembros',
  teams_manage_empty: 'No hay acciones de gestión de equipos.',
  teams_tools: 'Herramientas de equipo',
  teams_leave: 'Salir',
  teams_archive: 'Archivar',
  teams_soul_refresh: 'Actualizar SOUL',
  teams_soul_refreshed: 'SOUL actualizado',
  teams_archived: 'Equipo archivado',
  teams_left: 'Saliste del equipo',
  teams_disabled_members: 'Activa members.enabled en config.yaml primero.',
  teams_disabled_teams: 'Activa members.teams.enabled en config.yaml.',
  teams_sign_in_first: 'Inicia sesión para gestionar equipos.',
  teams_multi_banner: 'Selecciona un equipo activo en el menú de cuenta.',
  teams_my_teams: 'Mis equipos',
  teams_no_memberships: 'Aún no perteneces a ningún equipo.',
  teams_active: 'Activo',
  teams_use: 'Usar',
  teams_join: 'Unirse a un equipo',
  teams_create: 'Crear equipo',
  teams_display_name: 'Nombre para mostrar',
  teams_admin: 'Admin',
  teams_no_pending: 'No hay solicitudes de unión pendientes.',
  teams_approve: 'Aprobar',
  teams_reject: 'Rechazar',
  teams_active_set: 'Equipo activo actualizado',
  teams_context_refreshed: 'Equipo activo actualizado — chat actualizado.',
  teams_created: 'Equipo creado',
  teams_approved: 'Miembro aprobado',
  teams_rejected: 'Solicitud rechazada',
  teams_role_admin: 'Administrador del equipo',
  teams_members_manage: 'Miembros del equipo',
  teams_no_admin_teams: 'No eres administrador de ningún equipo.',
  teams_no_members: 'Sin miembros.',
  teams_promote_admin: 'Hacer administrador',
  teams_demote_admin: 'Quitar administrador',
  teams_admin_updated: 'Rol del equipo actualizado',
  teams_remove_member: 'Eliminar',
  teams_member_removed: 'Miembro eliminado',
  teams_open_panel: 'Abrir panel de equipos',
  projects_open_panel: 'Abrir panel de proyectos',
  projects_panel_desc: 'Únete a proyectos, elige uno activo y aprueba solicitudes.',
  projects_group_mine: 'Mis proyectos',
  projects_group_manage: 'Gestión de proyectos',
  projects_section_mine: 'Mis proyectos',
  projects_section_manage: 'Gestión de proyectos',
  projects_section_approvals: 'Aprobaciones de miembros',
  projects_manage_empty: 'No hay acciones de gestión de proyectos.',
  projects_tools: 'Herramientas de proyecto',
  projects_leave: 'Salir',
  projects_archive: 'Archivar',
  projects_archived: 'Proyecto archivado',
  projects_left: 'Saliste del proyecto',
  projects_disabled_members: 'Activa members.enabled en config.yaml primero.',
  projects_disabled_projects: 'Activa members.projects.enabled en config.yaml.',
  projects_sign_in_first: 'Inicia sesión para gestionar proyectos.',
  projects_multi_banner: 'Selecciona un proyecto activo en el menú de cuenta.',
  projects_my_projects: 'Mis proyectos',
  projects_no_memberships: 'Aún no perteneces a ningún proyecto.',
  projects_active: 'Activo',
  projects_use: 'Usar',
  projects_join: 'Unirse a un proyecto',
  projects_create: 'Crear proyecto',
  projects_display_name: 'Nombre para mostrar',
  projects_no_pending: 'No hay solicitudes de unión pendientes.',
  projects_approve: 'Aprobar',
  projects_reject: 'Rechazar',
  projects_active_set: 'Proyecto activo actualizado',
  projects_created: 'Proyecto creado',
  projects_approved: 'Miembro aprobado',
  projects_rejected: 'Solicitud rechazada',
  projects_role_admin: 'Administrador del proyecto',
  projects_members_manage: 'Miembros del proyecto',
  projects_no_admin_projects: 'No eres administrador de ningún proyecto.',
  projects_no_members: 'Sin miembros.',
  projects_promote_admin: 'Hacer administrador',
  projects_demote_admin: 'Quitar administrador',
  projects_admin_updated: 'Rol del proyecto actualizado',
  projects_remove_member: 'Eliminar',
  projects_member_removed: 'Miembro eliminado',
  projects_soul_edit: 'SOUL del proyecto',
  projects_soul_load: 'Cargar',
  projects_soul_save: 'Guardar SOUL',
  projects_soul_saved: 'SOUL guardado',
  projects_link_teams: 'Equipos vinculados',
  projects_link_team: 'Vincular equipo',
  projects_unlink_team: 'Desvincular',
  projects_team_linked: 'Equipo vinculado',
  projects_team_unlinked: 'Equipo desvinculado',
  projects_no_linked_teams: 'No hay equipos vinculados.',
  member_projects: 'Proyectos',
  projects_load_failed: 'No se pudo cargar el panel de proyectos.',
  checkpoint_date: '日期',
  checkpoint_diff_files_changed: '變更的檔案',
  checkpoint_diff_no_changes: '此檢查點無變更',
  checkpoint_diff_title: '檢查點差異',
...
path_copied: 'Dateipfad in die Zwischenablage kopiert',
 ...
 folder_add_as_space_title: 'Als Bereich hinzufügen?',
  ...
  agent_delete_confirm_message: 'Alle Sitzungen, Konfigurationen, Fähigkeiten und Erinnerungen dieses Profils werden dauerhaft gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.',
  ...
  agent_api_key_label: 'API-Schlüssel',
  ...
  agents_empty_title: 'Keine Profile',
  profiles_empty_title: 'Keine Profile',
  agents_empty_sub: 'Erstellen Sie Profile.',
  ...
  agents_no_agents: 'Keine Profile vorhanden.',
  profiles_no_profiles: 'Keine Profile vorhanden.',
  agent_api_keys_configured: 'API-Schlüssel konfiguriert',
  profile_api_keys_configured: 'API-Schlüssel konfiguriert',
  agent_gateway_running: 'Gateway läuft',
  ...
  agent_delete_title: 'Profil löschen',
  ...
  agent_model_hint: 'Wähle konfigurierte Anbieter und Modelle für dieses neue Profil.',
  ...
  agent_api_key_placeholder: 'sk-…',
  profile_api_key_placeholder: 'sk-…',
  manage_agents: 'Profile verwalten',
  manage_profiles: 'Profile verwalten',
  agents_load_failed: 'Profile konnten nicht geladen werden.',
  ...
  // ── Profile / Teams / Projects (de) ──
  profile_save_username: 'Benutzername speichern',
  profile_save_password: 'Passwort speichern',
  profile_local_user: 'Lokaler Benutzer',
  profile_team_none: 'Kein Team ausgewählt',
  profile_username_required: 'Benutzername ist erforderlich',
  profile_username_saved: 'Benutzername gespeichert',
  profile_password_required: 'Passwort eingeben',
  profile_avatar_removed: 'Avatar entfernt',
  profile_avatar_saved: 'Avatar aktualisiert',
  profile_avatar_type_error: 'JPEG, PNG oder WebP verwenden',
  profile_avatar_size_error: 'Avatar darf höchstens 512 KB groß sein',
  profile_save_failed: 'Speichern fehlgeschlagen: ',
  unlink: 'Verknüpfung aufheben',
  revoke: 'Widerrufen',
  teams_panel_desc: 'Teams beitreten, aktives Team wählen und Anfragen genehmigen.',
  teams_group_mine: 'Meine Teams',
  teams_group_manage: 'Teamverwaltung',
  teams_section_mine: 'Meine Teams',
  teams_section_manage: 'Teamverwaltung',
  teams_section_approvals: 'Mitgliederfreigaben',
  teams_manage_empty: 'Keine Teamverwaltungsaktionen verfügbar.',
  teams_tools: 'Team-Tools',
  teams_leave: 'Verlassen',
  teams_archive: 'Archivieren',
  teams_soul_refresh: 'SOUL aktualisieren',
  teams_soul_refreshed: 'SOUL aktualisiert',
  teams_archived: 'Team archiviert',
  teams_left: 'Team verlassen',
  teams_disabled_members: 'Zuerst members.enabled in config.yaml aktivieren.',
  teams_disabled_teams: 'Zuerst members.teams.enabled in config.yaml aktivieren.',
  teams_sign_in_first: 'Zum Verwalten von Teams anmelden.',
  teams_multi_banner: 'Aktives Team im Kontomenü auswählen.',
  teams_my_teams: 'Meine Teams',
  teams_no_memberships: 'Noch keine Teammitgliedschaften.',
  teams_active: 'Aktiv',
  teams_use: 'Verwenden',
  teams_join: 'Team beitreten',
  teams_create: 'Team erstellen',
  teams_display_name: 'Anzeigename',
  teams_admin: 'Admin',
  teams_no_pending: 'Keine ausstehenden Beitrittsanfragen.',
  teams_approve: 'Genehmigen',
  teams_reject: 'Ablehnen',
  teams_active_set: 'Aktives Team aktualisiert',
  teams_context_refreshed: 'Aktives Team aktualisiert — Chat aktualisiert.',
  teams_created: 'Team erstellt',
  teams_approved: 'Mitglied genehmigt',
  teams_rejected: 'Anfrage abgelehnt',
  teams_role_admin: 'Team-Administrator',
  teams_members_manage: 'Teammitglieder',
  teams_no_admin_teams: 'Sie sind Administrator in keinem Team.',
  teams_no_members: 'Keine Mitglieder.',
  teams_promote_admin: 'Zum Administrator machen',
  teams_demote_admin: 'Administrator entfernen',
  teams_admin_updated: 'Teamrolle aktualisiert',
  teams_remove_member: 'Entfernen',
  teams_member_removed: 'Mitglied entfernt',
  teams_open_panel: 'Team-Panel öffnen',
  projects_open_panel: 'Projekt-Panel öffnen',
  projects_panel_desc: 'Projekten beitreten, aktives Projekt wählen und Anfragen genehmigen.',
  projects_group_mine: 'Meine Projekte',
  projects_group_manage: 'Projektverwaltung',
  projects_section_mine: 'Meine Projekte',
  projects_section_manage: 'Projektverwaltung',
  projects_section_approvals: 'Mitgliederfreigaben',
  projects_manage_empty: 'Keine Projektverwaltungsaktionen verfügbar.',
  projects_tools: 'Projekt-Tools',
  projects_leave: 'Verlassen',
  projects_archive: 'Archivieren',
  projects_archived: 'Projekt archiviert',
  projects_left: 'Projekt verlassen',
  projects_disabled_members: 'Zuerst members.enabled in config.yaml aktivieren.',
  projects_disabled_projects: 'Zuerst members.projects.enabled in config.yaml aktivieren.',
  projects_sign_in_first: 'Zum Verwalten von Projekten anmelden.',
  projects_multi_banner: 'Aktives Projekt im Kontomenü auswählen.',
  projects_my_projects: 'Meine Projekte',
  projects_no_memberships: 'Noch keine Projektmitgliedschaften.',
  projects_active: 'Aktiv',
  projects_use: 'Verwenden',
  projects_join: 'Projekt beitreten',
  projects_create: 'Projekt erstellen',
  projects_display_name: 'Anzeigename',
  projects_no_pending: 'Keine ausstehenden Beitrittsanfragen.',
  projects_approve: 'Genehmigen',
  projects_reject: 'Ablehnen',
  projects_active_set: 'Aktives Projekt aktualisiert',
  projects_created: 'Projekt erstellt',
  projects_approved: 'Mitglied genehmigt',
  projects_rejected: 'Anfrage abgelehnt',
  projects_role_admin: 'Projekt-Administrator',
  projects_members_manage: 'Projektmitglieder',
  projects_no_admin_projects: 'Sie sind Administrator in keinem Projekt.',
  projects_no_members: 'Keine Mitglieder.',
  projects_promote_admin: 'Zum Administrator machen',
  projects_demote_admin: 'Administrator entfernen',
  projects_admin_updated: 'Projektrolle aktualisiert',
  projects_remove_member: 'Entfernen',
  projects_member_removed: 'Mitglied entfernt',
  projects_soul_edit: 'Projekt-SOUL',
  projects_soul_load: 'Laden',
  projects_soul_save: 'SOUL speichern',
  projects_soul_saved: 'SOUL gespeichert',
  projects_link_teams: 'Verknüpfte Teams',
  projects_link_team: 'Team verknüpfen',
  projects_unlink_team: 'Verknüpfung aufheben',
  projects_team_linked: 'Team verknüpft',
  projects_team_unlinked: 'Teamverknüpfung aufgehoben',
  projects_no_linked_teams: 'Keine verknüpften Teams.',
  member_projects: 'Projekte',
  projects_load_failed: 'Projekt-Panel konnte nicht geladen werden.',
  checkpoint_date: '日期',
  checkpoint_diff_files_changed: '變更的檔案',
  checkpoint_diff_no_changes: '此檢查點無變更',
  checkpoint_diff_title: '檢查點差異',
...
path_copied: 'Caminho do arquivo copiado para a área de transferência',
  ...
  agents_empty_title: 'Selecione um perfil',
  profiles_empty_title: 'Selecione um perfil',
  agents_empty_sub: 'Escolha perfil da sidebar para ver e editar settings.',
  ...
  cron_agent_label: 'Agent',
  cron_profile_label: 'Perfil',
  cron_agent_server_default: 'padrão do servidor',
  cron_profile_server_default: 'padrão do servidor',
  cron_agent_server_default_hint: 'Usa o perfil padrão do servidor WebUI no momento da execução. Tarefas existentes sem perfil mantêm esse comportamento legado.',
  ...
  agent_model_use_default: 'Usar o padrão do perfil ativo',
  ...
  manage_agents: 'Gerenciar perfis',
  manage_profiles: 'Gerenciar perfis',
  agents_load_failed: 'Falha ao carregar perfis',
  ...
  // ── Profile / Teams / Projects (pt) ──
  profile_save_username: 'Salvar nome de usuário',
  profile_save_password: 'Salvar senha',
  profile_local_user: 'Usuário local',
  profile_team_none: 'Nenhuma equipe selecionada',
  profile_username_required: 'Nome de usuário é obrigatório',
  profile_username_saved: 'Nome de usuário salvo',
  profile_password_required: 'Digite uma senha',
  profile_avatar_removed: 'Avatar removido',
  profile_avatar_saved: 'Avatar atualizado',
  profile_avatar_type_error: 'Use JPEG, PNG ou WebP',
  profile_avatar_size_error: 'O avatar deve ter 512 KB ou menos',
  profile_save_failed: 'Falha ao salvar: ',
  unlink: 'Desvincular',
  revoke: 'Revogar',
  teams_panel_desc: 'Entre em equipes, escolha uma ativa e aprove solicitações.',
  teams_group_mine: 'Minhas equipes',
  teams_group_manage: 'Gestão de equipes',
  teams_section_mine: 'Minhas equipes',
  teams_section_manage: 'Gestão de equipes',
  teams_section_approvals: 'Aprovações de membros',
  teams_manage_empty: 'Nenhuma ação de gestão de equipes disponível.',
  teams_tools: 'Ferramentas de equipe',
  teams_leave: 'Sair',
  teams_archive: 'Arquivar',
  teams_soul_refresh: 'Atualizar SOUL',
  teams_soul_refreshed: 'SOUL atualizado',
  teams_archived: 'Equipe arquivada',
  teams_left: 'Saiu da equipe',
  teams_disabled_members: 'Ative members.enabled em config.yaml primeiro.',
  teams_disabled_teams: 'Ative members.teams.enabled em config.yaml.',
  teams_sign_in_first: 'Entre para gerenciar equipes.',
  teams_multi_banner: 'Selecione uma equipe ativa no menu da conta.',
  teams_my_teams: 'Minhas equipes',
  teams_no_memberships: 'Ainda não pertence a nenhuma equipe.',
  teams_active: 'Ativa',
  teams_use: 'Usar',
  teams_join: 'Entrar em uma equipe',
  teams_create: 'Criar equipe',
  teams_display_name: 'Nome de exibição',
  teams_admin: 'Admin',
  teams_no_pending: 'Nenhuma solicitação de entrada pendente.',
  teams_approve: 'Aprovar',
  teams_reject: 'Rejeitar',
  teams_active_set: 'Equipe ativa atualizada',
  teams_context_refreshed: 'Equipe ativa atualizada — chat atualizado.',
  teams_created: 'Equipe criada',
  teams_approved: 'Membro aprovado',
  teams_rejected: 'Solicitação rejeitada',
  teams_role_admin: 'Administrador da equipe',
  teams_members_manage: 'Membros da equipe',
  teams_no_admin_teams: 'Você não é administrador de nenhuma equipe.',
  teams_no_members: 'Sem membros.',
  teams_promote_admin: 'Tornar administrador',
  teams_demote_admin: 'Remover administrador',
  teams_admin_updated: 'Função da equipe atualizada',
  teams_remove_member: 'Remover',
  teams_member_removed: 'Membro removido',
  teams_open_panel: 'Abrir painel de equipes',
  projects_open_panel: 'Abrir painel de projetos',
  projects_panel_desc: 'Entre em projetos, escolha um ativo e aprove solicitações.',
  projects_group_mine: 'Meus projetos',
  projects_group_manage: 'Gestão de projetos',
  projects_section_mine: 'Meus projetos',
  projects_section_manage: 'Gestão de projetos',
  projects_section_approvals: 'Aprovações de membros',
  projects_manage_empty: 'Nenhuma ação de gestão de projetos disponível.',
  projects_tools: 'Ferramentas de projeto',
  projects_leave: 'Sair',
  projects_archive: 'Arquivar',
  projects_archived: 'Projeto arquivado',
  projects_left: 'Saiu do projeto',
  projects_disabled_members: 'Ative members.enabled em config.yaml primeiro.',
  projects_disabled_projects: 'Ative members.projects.enabled em config.yaml.',
  projects_sign_in_first: 'Entre para gerenciar projetos.',
  projects_multi_banner: 'Selecione um projeto ativo no menu da conta.',
  projects_my_projects: 'Meus projetos',
  projects_no_memberships: 'Ainda não pertence a nenhum projeto.',
  projects_active: 'Ativo',
  projects_use: 'Usar',
  projects_join: 'Entrar em um projeto',
  projects_create: 'Criar projeto',
  projects_display_name: 'Nome de exibição',
  projects_no_pending: 'Nenhuma solicitação de entrada pendente.',
  projects_approve: 'Aprovar',
  projects_reject: 'Rejeitar',
  projects_active_set: 'Projeto ativo atualizado',
  projects_created: 'Projeto criado',
  projects_approved: 'Membro aprovado',
  projects_rejected: 'Solicitação rejeitada',
  projects_role_admin: 'Administrador do projeto',
  projects_members_manage: 'Membros do projeto',
  projects_no_admin_projects: 'Você não é administrador de nenhum projeto.',
  projects_no_members: 'Sem membros.',
  projects_promote_admin: 'Tornar administrador',
  projects_demote_admin: 'Remover administrador',
  projects_admin_updated: 'Função do projeto atualizada',
  projects_remove_member: 'Remover',
  projects_member_removed: 'Membro removido',
  projects_soul_edit: 'SOUL do projeto',
  projects_soul_load: 'Carregar',
  projects_soul_save: 'Salvar SOUL',
  projects_soul_saved: 'SOUL salvo',
  projects_link_teams: 'Equipes vinculadas',
  projects_link_team: 'Vincular equipe',
  projects_unlink_team: 'Desvincular',
  projects_team_linked: 'Equipe vinculada',
  projects_team_unlinked: 'Equipe desvinculada',
  projects_no_linked_teams: 'Nenhuma equipe vinculada.',
  member_projects: 'Projetos',
  projects_load_failed: 'Não foi possível carregar o painel de projetos.',
  checkpoint_date: '日期',
  checkpoint_diff_files_changed: '變更的檔案',
  checkpoint_diff_no_changes: '此檢查點無變更',
  checkpoint_diff_title: '檢查點差異',
...
path_copied: '파일 경로가 클립보드에 복사되었습니다',
  ...
  kanban_assignee_agents_label: 'Intellect 프로필',
  ...
  // ── Profile / Teams / Projects (ko) ──
  profile_save_username: '사용자 이름 저장',
  profile_save_password: '비밀번호 저장',
  profile_local_user: '로컬 사용자',
  profile_team_none: '선택된 팀 없음',
  profile_username_required: '사용자 이름은 필수입니다',
  profile_username_saved: '사용자 이름이 저장되었습니다',
  profile_password_required: '비밀번호를 입력하세요',
  profile_avatar_removed: '아바타가 제거되었습니다',
  profile_avatar_saved: '아바타가 업데이트되었습니다',
  profile_avatar_type_error: 'JPEG, PNG 또는 WebP를 사용하세요',
  profile_avatar_size_error: '아바타는 512KB 이하여야 합니다',
  profile_save_failed: '저장 실패: ',
  unlink: '연결 해제',
  revoke: '취소',
  teams_panel_desc: '팀에 가입하고 활성 팀을 선택하며 요청을 승인합니다.',
  teams_group_mine: '내 팀',
  teams_group_manage: '팀 관리',
  teams_section_mine: '내 팀',
  teams_section_manage: '팀 관리',
  teams_section_approvals: '멤버 승인',
  teams_manage_empty: '팀 관리 작업이 없습니다.',
  teams_tools: '팀 도구',
  teams_leave: '나가기',
  teams_archive: '보관',
  teams_soul_refresh: 'SOUL 새로고침',
  teams_soul_refreshed: 'SOUL이 새로고침되었습니다',
  teams_archived: '팀이 보관되었습니다',
  teams_left: '팀에서 나갔습니다',
  teams_disabled_members: '먼저 config.yaml에서 members.enabled를 활성화하세요.',
  teams_disabled_teams: '먼저 config.yaml에서 members.teams.enabled를 활성화하세요.',
  teams_sign_in_first: '팀을 관리하려면 로그인하세요.',
  teams_multi_banner: '계정 메뉴에서 활성 팀을 선택하세요.',
  teams_my_teams: '내 팀',
  teams_no_memberships: '아직 팀에 가입하지 않았습니다.',
  teams_active: '활성',
  teams_use: '사용',
  teams_join: '팀 가입',
  teams_create: '팀 만들기',
  teams_display_name: '표시 이름',
  teams_admin: '관리',
  teams_no_pending: '대기 중인 가입 요청이 없습니다.',
  teams_approve: '승인',
  teams_reject: '거절',
  teams_active_set: '활성 팀이 업데이트되었습니다',
  teams_context_refreshed: '활성 팀 업데이트 — 채팅이 새로고침되었습니다.',
  teams_created: '팀이 생성되었습니다',
  teams_approved: '멤버가 승인되었습니다',
  teams_rejected: '요청이 거절되었습니다',
  teams_role_admin: '팀 관리자',
  teams_members_manage: '팀 멤버',
  teams_no_admin_teams: '관리자인 팀이 없습니다.',
  teams_no_members: '멤버가 없습니다.',
  teams_promote_admin: '관리자로 지정',
  teams_demote_admin: '관리자 해제',
  teams_admin_updated: '팀 역할이 업데이트되었습니다',
  teams_remove_member: '제거',
  teams_member_removed: '멤버가 제거되었습니다',
  teams_open_panel: '팀 패널 열기',
  projects_open_panel: '프로젝트 패널 열기',
  projects_panel_desc: '프로젝트에 가입하고 활성 프로젝트를 선택하며 요청을 승인합니다.',
  projects_group_mine: '내 프로젝트',
  projects_group_manage: '프로젝트 관리',
  projects_section_mine: '내 프로젝트',
  projects_section_manage: '프로젝트 관리',
  projects_section_approvals: '멤버 승인',
  projects_manage_empty: '프로젝트 관리 작업이 없습니다.',
  projects_tools: '프로젝트 도구',
  projects_leave: '나가기',
  projects_archive: '보관',
  projects_archived: '프로젝트가 보관되었습니다',
  projects_left: '프로젝트에서 나갔습니다',
  projects_disabled_members: '먼저 config.yaml에서 members.enabled를 활성화하세요.',
  projects_disabled_projects: '먼저 config.yaml에서 members.projects.enabled를 활성화하세요.',
  projects_sign_in_first: '프로젝트를 관리하려면 로그인하세요.',
  projects_multi_banner: '계정 메뉴에서 활성 프로젝트를 선택하세요.',
  projects_my_projects: '내 프로젝트',
  projects_no_memberships: '아직 프로젝트에 가입하지 않았습니다.',
  projects_active: '활성',
  projects_use: '사용',
  projects_join: '프로젝트 가입',
  projects_create: '프로젝트 만들기',
  projects_display_name: '표시 이름',
  projects_no_pending: '대기 중인 가입 요청이 없습니다.',
  projects_approve: '승인',
  projects_reject: '거절',
  projects_active_set: '활성 프로젝트가 업데이트되었습니다',
  projects_created: '프로젝트가 생성되었습니다',
  projects_approved: '멤버가 승인되었습니다',
  projects_rejected: '요청이 거절되었습니다',
  projects_role_admin: '프로젝트 관리자',
  projects_members_manage: '프로젝트 멤버',
  projects_no_admin_projects: '관리자인 프로젝트가 없습니다.',
  projects_no_members: '멤버가 없습니다.',
  projects_promote_admin: '관리자로 지정',
  projects_demote_admin: '관리자 해제',
  projects_admin_updated: '프로젝트 역할이 업데이트되었습니다',
  projects_remove_member: '제거',
  projects_member_removed: '멤버가 제거되었습니다',
  projects_soul_edit: '프로젝트 SOUL',
  projects_soul_load: '불러오기',
  projects_soul_save: 'SOUL 저장',
  projects_soul_saved: 'SOUL이 저장되었습니다',
  projects_link_teams: '연결된 팀',
  projects_link_team: '팀 연결',
  projects_unlink_team: '연결 해제',
  projects_team_linked: '팀이 연결되었습니다',
  projects_team_unlinked: '팀 연결이 해제되었습니다',
  projects_no_linked_teams: '연결된 팀이 없습니다.',
  member_projects: '프로젝트',
  projects_load_failed: '프로젝트 패널을 불러올 수 없습니다.',
  checkpoint_date: '日期',
  checkpoint_diff_files_changed: '變更的檔案',
  checkpoint_diff_no_changes: '此檢查點無變更',
  checkpoint_diff_title: '檢查點差異',
 ...
 fr: {
  ...
  kanban_assignee_agents_label: 'Profils Hermès',
  ...
  agents_empty_title: 'Sélectionnez un profil',
  ...
  agent_model_label: 'Modèle / fournisseur',
  profile_model_label: 'Modèle / fournisseur',
  agent_model_hint: 'Choisissez parmi les fournisseurs et modèles configurés pour ce nouveau profil.',
  profile_model_hint: 'Choisissez parmi les fournisseurs et modèles configurés pour ce nouveau profil.',
  agent_model_use_default: 'Utiliser la valeur par défaut du profil actif',
  ...
  agent_api_key_placeholder: 'Clé API (facultatif)',
  profile_api_key_placeholder: 'Clé API (facultatif)',
  manage_agents: 'Gérer les profils',
  manage_profiles: 'Gérer les profils',
  agents_load_failed: 'Échec du chargement des profils',
  ...
  agent_delete_confirm_message: 'Toutes les sessions, configurations, compétences et mémoire de ce profil seront définitivement supprimées. Cela ne peut pas être annulé.',
  ...
  cron_agent_label: 'Agent',
  cron_profile_label: 'Profil',
  cron_agent_server_default: 'serveur par défaut',
  ...
  // ── Profile / Teams / Projects (fr) ──
  profile_save_username: 'Enregistrer le nom d\'utilisateur',
  profile_save_password: 'Enregistrer le mot de passe',
  profile_local_user: 'Utilisateur local',
  profile_team_none: 'Aucune équipe sélectionnée',
  profile_username_required: 'Le nom d\'utilisateur est requis',
  profile_username_saved: 'Nom d\'utilisateur enregistré',
  profile_password_required: 'Saisissez un mot de passe',
  profile_avatar_removed: 'Avatar supprimé',
  profile_avatar_saved: 'Avatar mis à jour',
  profile_avatar_type_error: 'Utilisez JPEG, PNG ou WebP',
  profile_avatar_size_error: 'L\'avatar doit faire 512 Ko ou moins',
  profile_save_failed: 'Échec de l\'enregistrement : ',
  unlink: 'Dissocier',
  revoke: 'Révoquer',
  teams_panel_desc: 'Rejoignez des équipes, choisissez une équipe active et approuvez les demandes.',
  teams_group_mine: 'Mes équipes',
  teams_group_manage: 'Gestion des équipes',
  teams_section_mine: 'Mes équipes',
  teams_section_manage: 'Gestion des équipes',
  teams_section_approvals: 'Approbations des membres',
  teams_manage_empty: 'Aucune action de gestion d\'équipe disponible.',
  teams_tools: 'Outils d\'équipe',
  teams_leave: 'Quitter',
  teams_archive: 'Archiver',
  teams_soul_refresh: 'Actualiser SOUL',
  teams_soul_refreshed: 'SOUL actualisé',
  teams_archived: 'Équipe archivée',
  teams_left: 'Équipe quittée',
  teams_disabled_members: 'Activez d\'abord members.enabled dans config.yaml.',
  teams_disabled_teams: 'Activez members.teams.enabled dans config.yaml.',
  teams_sign_in_first: 'Connectez-vous pour gérer les équipes.',
  teams_multi_banner: 'Sélectionnez une équipe active dans le menu du compte.',
  teams_my_teams: 'Mes équipes',
  teams_no_memberships: 'Vous n\'appartenez encore à aucune équipe.',
  teams_active: 'Active',
  teams_use: 'Utiliser',
  teams_join: 'Rejoindre une équipe',
  teams_create: 'Créer une équipe',
  teams_display_name: 'Nom affiché',
  teams_admin: 'Admin',
  teams_no_pending: 'Aucune demande d\'adhésion en attente.',
  teams_approve: 'Approuver',
  teams_reject: 'Rejeter',
  teams_active_set: 'Équipe active mise à jour',
  teams_context_refreshed: 'Équipe active mise à jour — chat actualisé.',
  teams_created: 'Équipe créée',
  teams_approved: 'Membre approuvé',
  teams_rejected: 'Demande rejetée',
  teams_role_admin: 'Administrateur d\'équipe',
  teams_members_manage: 'Membres de l\'équipe',
  teams_no_admin_teams: 'Vous n\'êtes administrateur d\'aucune équipe.',
  teams_no_members: 'Aucun membre.',
  teams_promote_admin: 'Nommer administrateur',
  teams_demote_admin: 'Retirer administrateur',
  teams_admin_updated: 'Rôle d\'équipe mis à jour',
  teams_remove_member: 'Retirer',
  teams_member_removed: 'Membre retiré',
  teams_open_panel: 'Ouvrir le panneau Équipes',
  projects_open_panel: 'Ouvrir le panneau Projets',
  projects_panel_desc: 'Rejoignez des projets, choisissez un projet actif et approuvez les demandes.',
  projects_group_mine: 'Mes projets',
  projects_group_manage: 'Gestion des projets',
  projects_section_mine: 'Mes projets',
  projects_section_manage: 'Gestion des projets',
  projects_section_approvals: 'Approbations des membres',
  projects_manage_empty: 'Aucune action de gestion de projet disponible.',
  projects_tools: 'Outils de projet',
  projects_leave: 'Quitter',
  projects_archive: 'Archiver',
  projects_archived: 'Projet archivé',
  projects_left: 'Projet quitté',
  projects_disabled_members: 'Activez d\'abord members.enabled dans config.yaml.',
  projects_disabled_projects: 'Activez members.projects.enabled dans config.yaml.',
  projects_sign_in_first: 'Connectez-vous pour gérer les projets.',
  projects_multi_banner: 'Sélectionnez un projet actif dans le menu du compte.',
  projects_my_projects: 'Mes projets',
  projects_no_memberships: 'Vous n\'appartenez encore à aucun projet.',
  projects_active: 'Actif',
  projects_use: 'Utiliser',
  projects_join: 'Rejoindre un projet',
  projects_create: 'Créer un projet',
  projects_display_name: 'Nom affiché',
  projects_no_pending: 'Aucune demande d\'adhésion en attente.',
  projects_approve: 'Approuver',
  projects_reject: 'Rejeter',
  projects_active_set: 'Projet actif mis à jour',
  projects_created: 'Projet créé',
  projects_approved: 'Membre approuvé',
  projects_rejected: 'Demande rejetée',
  projects_role_admin: 'Administrateur de projet',
  projects_members_manage: 'Membres du projet',
  projects_no_admin_projects: 'Vous n\'êtes administrateur d\'aucun projet.',
  projects_no_members: 'Aucun membre.',
  projects_promote_admin: 'Nommer administrateur',
  projects_demote_admin: 'Retirer administrateur',
  projects_admin_updated: 'Rôle de projet mis à jour',
  projects_remove_member: 'Retirer',
  projects_member_removed: 'Membre retiré',
  projects_soul_edit: 'SOUL du projet',
  projects_soul_load: 'Charger',
  projects_soul_save: 'Enregistrer SOUL',
  projects_soul_saved: 'SOUL enregistré',
  projects_link_teams: 'Équipes liées',
  projects_link_team: 'Lier une équipe',
  projects_unlink_team: 'Dissocier',
  projects_team_linked: 'Équipe liée',
  projects_team_unlinked: 'Équipe dissociée',
  projects_no_linked_teams: 'Aucune équipe liée.',
  member_projects: 'Projets',
  projects_load_failed: 'Impossible de charger le panneau Projets.',
 ...
 tr: {
  ...
  offline_network_detail: 'Intellect\'e şu anda bu tarayıcıdan ulaşılamıyor.',
  offline_autorefresh: 'Intellect\'e tekrar ulaşılabilir olduğunda bu sayfayı otomatik olarak yenileyeceğim.',
  ...
  mcp_restart_hint: 'Sunucu değişiklikleri şimdilik burada salt okunurdur. Değişikliklerin etkili olması için config.yaml dosyasını düzenleyin ve Intellect\'i yeniden başlatın.',
  ...
  provider_mismatch_warning: (m,p) => `"${m}" yapılandırılmış sağlayıcınızla (${p}) çalışmayabilir. Yine de gönderin veya geçiş yapmak için terminalinizde \`intellect model\` komutunu çalıştırın.`,
  ...
  cmd_skills: 'Mevcut Intellect becerilerini listele',
  ...
  status_profile: 'Profil',
  status_intellect_home: 'Intellect\'in evi',
  ...
  no_personalities: 'Hiç kişilik bulunamadı (onları ~/.intellect/personalities/ dosyasına ekleyin)',
  ...
  settings_section_preferences_meta: 'Intellect Web Kullanıcı Arayüzü için varsayılanlar ve Kullanıcı Arayüzü davranışı.',
  ...
  settings_plugins_meta: 'Yüklü Intellect eklentilerini ve yaşam döngüsü kancalarını görüntüleyin. Bu panel salt okunurdur.',
  settings_plugins_empty: 'Görünür Intellect eklentisi yok. Burada görmek için Intellect CLI/config üzerinden yükleyin veya etkinleştirin.',
  ...
  kanban_work_queue_hint: 'Bu Intellect Ajanının iş kuyruğudur. Bir görev oluşturun veya önceliklendirin, atayın, Hazır\'a taşıyın ve sevk görevlisinin görevi talep etmesine izin verin.',
  ...
  kanban_assignee_agents_label: 'Intellect agents',
  kanban_assignee_profiles_label: 'Intellect profilleri',
  ...
  tab_dashboard: 'Intellect Kontrol Paneli',
  ...
  settings_desc_sync_insights: 'WebUI belirteci kullanımını state.db\'ye yansıtır, böylece.intellect /insights tarayıcı oturum verilerini içerir. Varsayılan olarak kapalıdır.',
  ...
  settings_label_shutdown: 'Intellect WebUI sunucusunu durdur',
  ...
  settings_shutdown_confirm_title: 'Intellect WebUI\'yi durdur',
  settings_shutdown_confirm_message: 'Intellect WebUI sunucusu durdurulsun mu?',
  ...
  providers_oauth_config_yaml_hint: 'Belirteç config.yaml aracılığıyla yapılandırıldı. Güncellemek için config.yaml dosyanızdaki sağlayıcılar bölümünü düzenleyin veya.intellect auth\'u çalıştırın.',
  providers_oauth_not_configured_hint: 'Kimliği doğrulanmadı. Bu sağlayıcıyı yapılandırmak için terminalde Intellect Auth komutunu çalıştırın.',
  ...
  onboarding_title: 'Intellect Web Kullanıcı Arayüzüne Hoş Geldiniz',
  onboarding_lead: 'Hızlı yönlendirmeli kurulum, Intellect\'i doğrulayacak, gerçek bir sağlayıcı yapılandırmasını kaydedecek, bir çalışma alanı ve modeli seçecek ve isteğe bağlı olarak uygulamayı bir parola ile koruyacaktır.',
  ...
  onboarding_open: 'Intellect\'i aç',
  onboarding_step_system_title: 'Sistem kontrolü',
  onboarding_step_system_desc: 'Intellect Agent\'ı ve yapılandırma görünürlüğünü doğrulayın.',
  onboarding_step_setup_title: 'Sağlayıcı kurulumu',
  onboarding_step_setup_desc: 'Minimum Intellect sağlayıcı yapılandırmasını kaydedin.',
  ...
  onboarding_notice_system_ready: 'Intellect Agent\'a Web kullanıcı arayüzünden ulaşılabilir görünüyor.',
  onboarding_notice_system_unavailable: 'Intellect Agent henüz tam olarak mevcut değil. Bootstrap bunu kurabilir ancak sağlayıcı kurulumu yine de bir terminal gerektirebilir.',
  onboarding_check_agent: 'Intellect Temsilcisi',
  ...
  onboarding_notice_setup_required: 'Burada basit bir sağlayıcı yolu seçin. Gelişmiş OAuth akışları şimdilik Intellect CLI\'ye ait olmaya devam ediyor.',
  onboarding_notice_setup_already_ready: 'Çalışan bir Intellect sağlayıcı kurulumu zaten algılandı. Burada saklayabilir veya değiştirebilirsiniz.',
  onboarding_oauth_provider_ready_title: 'Sağlayıcının kimliği zaten doğrulandı',
  onboarding_oauth_provider_ready_body: 'Bu örnek, Intellect CLI aracılığıyla ayarlanmış bir OAuth sağlayıcısını (<strong>{provider}</strong>) kullanacak şekilde yapılandırılmıştır. Burada API anahtarına gerek yoktur; kurulumu tamamlamak için Devam\'a tıklayın.',
  onboarding_oauth_provider_not_ready_title: 'OAuth sağlayıcısının kimliği henüz doğrulanmadı',
  onboarding_oauth_provider_not_ready_body: 'Bu örnek, API anahtarı yerine OAuth kullanan <strong>{provider}</strong> sağlayıcısını kullanır. Kimlik doğrulamak için terminalde <code.intellect auth</code> veya <code>intellect model</code> çalıştırın, ardından WebUI\'yi yeniden yükleyin.',
  ...
  onboarding_api_key_help_prefix: 'Intellect .env dosyanızda gizli olarak kaydedildi',
  ...
  onboarding_workspace_help: 'Kurulum tamamlandıktan sonra Intellect\'in yeni sohbetler için kullanması gereken modeli seçin.',
  ...
  agents_empty_title: 'Bir profil seçin',
  profiles_empty_title: 'Bir profil seçin',
  agents_empty_sub: 'Ayarlarını görüntülemek ve düzenlemek için kenar çubuğundan bir temsilci profili seçin veya yeni bir tane oluşturun.',
  ...
  agent_name_rule: 'Yalnızca küçük harfler, sayılar, kısa çizgiler ve alt çizgiler',
  profile_name_rule: 'Yalnızca küçük harfler, sayılar, kısa çizgiler ve alt çizgiler',
  agent_base_url_rule: 'Temel URL http:// veya https:// ile başlamalıdır',
  ...
  agent_delete_confirm_message: 'Bu profilin tüm oturumları, yapılandırmaları, becerileri ve belleği kalıcı olarak silinecek. Bu geri alınamaz.',
  ...
  cron_agent_label: 'Agent',
  cron_profile_label: 'Profil',
  cron_agent_server_default: 'sunucu varsayılanı',
  cron_profile_server_default: 'sunucu varsayılanı',
  cron_agent_server_default_hint: 'Çalışma zamanında WebUI sunucusunun varsayılan profilini kullanır. Profili olmayan mevcut işler bu eski davranışı sürdürüyor.',
  ...
  settings_desc_voice_mode: 'Dikte mikrofonunun yanında ses modu düğmesini gösterir. Duraklamadan sonra Intellect otomatik gönderir ve yanıtları sesli okur. Konuşma tanıma ve TTS destekleyen tarayıcı gerektirir.',
  ...
  // ── Profile / Teams / Projects (tr) ──
  profile_save_username: 'Kullanıcı adını kaydet',
  profile_save_password: 'Parolayı kaydet',
  profile_local_user: 'Yerel kullanıcı',
  profile_team_none: 'Seçili takım yok',
  profile_username_required: 'Kullanıcı adı gerekli',
  profile_username_saved: 'Kullanıcı adı kaydedildi',
  profile_password_required: 'Bir parola girin',
  profile_avatar_removed: 'Avatar kaldırıldı',
  profile_avatar_saved: 'Avatar güncellendi',
  profile_avatar_type_error: 'JPEG, PNG veya WebP kullanın',
  profile_avatar_size_error: 'Avatar 512 KB veya daha küçük olmalı',
  profile_save_failed: 'Kaydetme başarısız: ',
  unlink: 'Bağlantıyı kaldır',
  revoke: 'İptal et',
  teams_panel_desc: 'Takımlara katılın, aktif takımı seçin ve istekleri onaylayın.',
  teams_group_mine: 'Takımlarım',
  teams_group_manage: 'Takım yönetimi',
  teams_section_mine: 'Takımlarım',
  teams_section_manage: 'Takım yönetimi',
  teams_section_approvals: 'Üye onayları',
  teams_manage_empty: 'Takım yönetimi işlemi yok.',
  teams_tools: 'Takım araçları',
  teams_leave: 'Ayrıl',
  teams_archive: 'Arşivle',
  teams_soul_refresh: 'SOUL yenile',
  teams_soul_refreshed: 'SOUL yenilendi',
  teams_archived: 'Takım arşivlendi',
  teams_left: 'Takımdan ayrıldınız',
  teams_disabled_members: 'Önce config.yaml içinde members.enabled etkinleştirin.',
  teams_disabled_teams: 'Önce config.yaml içinde members.teams.enabled etkinleştirin.',
  teams_sign_in_first: 'Takımları yönetmek için oturum açın.',
  teams_multi_banner: 'Hesap menüsünden aktif takımı seçin.',
  teams_my_teams: 'Takımlarım',
  teams_no_memberships: 'Henüz bir takıma katılmadınız.',
  teams_active: 'Aktif',
  teams_use: 'Kullan',
  teams_join: 'Takıma katıl',
  teams_create: 'Takım oluştur',
  teams_display_name: 'Görünen ad',
  teams_admin: 'Yönetici',
  teams_no_pending: 'Bekleyen katılım isteği yok.',
  teams_approve: 'Onayla',
  teams_reject: 'Reddet',
  teams_active_set: 'Aktif takım güncellendi',
  teams_context_refreshed: 'Aktif takım güncellendi — sohbet yenilendi.',
  teams_created: 'Takım oluşturuldu',
  teams_approved: 'Üye onaylandı',
  teams_rejected: 'İstek reddedildi',
  teams_role_admin: 'Takım yöneticisi',
  teams_members_manage: 'Takım üyeleri',
  teams_no_admin_teams: 'Yönetici olduğunuz takım yok.',
  teams_no_members: 'Üye yok.',
  teams_promote_admin: 'Yönetici yap',
  teams_demote_admin: 'Yöneticiliği kaldır',
  teams_admin_updated: 'Takım rolü güncellendi',
  teams_remove_member: 'Kaldır',
  teams_member_removed: 'Üye kaldırıldı',
  teams_open_panel: 'Takımlar panelini aç',
  projects_open_panel: 'Projeler panelini aç',
  projects_panel_desc: 'Projelere katılın, aktif projeyi seçin ve istekleri onaylayın.',
  projects_group_mine: 'Projelerim',
  projects_group_manage: 'Proje yönetimi',
  projects_section_mine: 'Projelerim',
  projects_section_manage: 'Proje yönetimi',
  projects_section_approvals: 'Üye onayları',
  projects_manage_empty: 'Proje yönetimi işlemi yok.',
  projects_tools: 'Proje araçları',
  projects_leave: 'Ayrıl',
  projects_archive: 'Arşivle',
  projects_archived: 'Proje arşivlendi',
  projects_left: 'Projeden ayrıldınız',
  projects_disabled_members: 'Önce config.yaml içinde members.enabled etkinleştirin.',
  projects_disabled_projects: 'Önce config.yaml içinde members.projects.enabled etkinleştirin.',
  projects_sign_in_first: 'Projeleri yönetmek için oturum açın.',
  projects_multi_banner: 'Hesap menüsünden aktif projeyi seçin.',
  projects_my_projects: 'Projelerim',
  projects_no_memberships: 'Henüz bir projeye katılmadınız.',
  projects_active: 'Aktif',
  projects_use: 'Kullan',
  projects_join: 'Projeye katıl',
  projects_create: 'Proje oluştur',
  projects_display_name: 'Görünen ad',
  projects_no_pending: 'Bekleyen katılım isteği yok.',
  projects_approve: 'Onayla',
  projects_reject: 'Reddet',
  projects_active_set: 'Aktif proje güncellendi',
  projects_created: 'Proje oluşturuldu',
  projects_approved: 'Üye onaylandı',
  projects_rejected: 'İstek reddedildi',
  projects_role_admin: 'Proje yöneticisi',
  projects_members_manage: 'Proje üyeleri',
  projects_no_admin_projects: 'Yönetici olduğunuz proje yok.',
  projects_no_members: 'Üye yok.',
  projects_promote_admin: 'Yönetici yap',
  projects_demote_admin: 'Yöneticiliği kaldır',
  projects_admin_updated: 'Proje rolü güncellendi',
  projects_remove_member: 'Kaldır',
  projects_member_removed: 'Üye kaldırıldı',
  projects_soul_edit: 'Proje SOUL',
  projects_soul_load: 'Yükle',
  projects_soul_save: 'SOUL kaydet',
  projects_soul_saved: 'SOUL kaydedildi',
  projects_link_teams: 'Bağlı takımlar',
  projects_link_team: 'Takım bağla',
  projects_unlink_team: 'Bağlantıyı kaldır',
  projects_team_linked: 'Takım bağlandı',
  projects_team_unlinked: 'Takım bağlantısı kaldırıldı',
  projects_no_linked_teams: 'Bağlı takım yok.',
  member_projects: 'Projeler',
  projects_load_failed: 'Projeler paneli yüklenemedi.',
 ...
 * @returns {string}
 */
// Legacy agent-home i18n keys (profile_*) resolve to agent_*.
const I18N_AGENT_HOME_ALIASES = {
  'profiles_empty_title': 'agents_empty_title',
  'profiles_empty_sub': 'agents_empty_sub',
  'profiles_no_profiles': 'agents_no_agents',
  'profiles_load_failed': 'agents_load_failed',
  'manage_profiles': 'manage_agents',
  'profile_api_keys_configured': 'agent_api_keys_configured',
  'profile_gateway_running': 'agent_gateway_running',
  'profile_gateway_stopped': 'agent_gateway_stopped',
  'profile_active': 'agent_active',
  'profile_no_configuration': 'agent_no_configuration',
  'profile_skill_count': 'agent_skill_count',
  'profile_use': 'agent_use',
  'profile_switch_title': 'agent_switch_title',
  'profile_delete_title': 'agent_delete_title',
  'profile_default_label': 'agent_default_label',
  'profile_name_placeholder': 'agent_name_placeholder',
  'profile_clone_label': 'agent_clone_label',
  'profile_model_label': 'agent_model_label',
  'profile_model_hint': 'agent_model_hint',
  'profile_model_use_default': 'agent_model_use_default',
  'profile_base_url_placeholder': 'agent_base_url_placeholder',
  'profile_api_key_placeholder': 'agent_api_key_placeholder',
  'profile_switched_new_conversation': 'agent_switched_new_conversation',
  'profile_switched': 'agent_switched',
  'profile_name_rule': 'agent_name_rule',
  'profile_base_url_rule': 'agent_base_url_rule',
  'profile_created': 'agent_created',
  'profile_delete_confirm_title': 'agent_delete_confirm_title',
  'profile_delete_confirm_message': 'agent_delete_confirm_message',
  'profile_deleted': 'agent_deleted',
  'profile_name_label': 'agent_name_label',
  'profile_base_url_label': 'agent_base_url_label',
  'profile_api_key_label': 'agent_api_key_label',
  'cron_profile_label': 'cron_agent_label',
  'cron_profile_server_default': 'cron_agent_server_default',
  'cron_profile_server_default_hint': 'cron_agent_server_default_hint',
  'kanban_assignee_profiles_label': 'kanban_assignee_agents_label',
};

function t(key, ...args) {
 const resolved = I18N_AGENT_HOME_ALIASES[key] || key;
 const val = _locale[resolved] ?? _locale[key] ?? LOCALES.en[resolved] ?? LOCALES.en[key];
