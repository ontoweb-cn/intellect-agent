...
import type { ScrollBoxHandle } from '@intellect/ink'
import { evictInkCaches } from '@intellect/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.intellect_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
