 ...
 *
 * Symptom: in `intellect --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@intellect/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using intellect --tui and as i type multiline my caret at the end will often ' +
