...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://gitee.com/ontoweb/intellect-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/intellect-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://gitee.com/ontoweb/intellect-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/ONTOWEB',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/ONTOWEB' },
            { label: 'GitHub Discussions', href: 'https://gitee.com/ontoweb/intellect-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://gitee.com/ontoweb/intellect-agent' },
            { label: 'ONTOWEB', href: 'https://ontoweb.cn' },
          ],
        },
      ],
      copyright: `Built by <a href="https://ontoweb.cn">ONTOWEB</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
