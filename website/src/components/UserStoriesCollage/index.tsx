  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Intellect Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Intellect &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Intellect?{' '}
        <a
          href="https://gitee.com/ontoweb/intellect-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/ONTOWEB" target="_blank" rel="noopener noreferrer">
          ONTOWEB Discord
        </a>{' '}
