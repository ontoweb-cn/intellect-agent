---
sidebar_position: 8
title: "Use Voice Mode with Intellect"
description: "A practical guide to setting up and using Intellect voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Intellect
...
:::tip
[ONTOWEB Portal](/integrations/ontoweb-portal) bundles both the LLM and TTS through one OAuth — voice mode works end-to-end with no extra credentials.
:::
...
- you want Intellect sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Intellect.
...
## Step 1: make sure normal Intellect works first
...
Intellect supports both local and cloud speech stacks.
...
4. Intellect transcribes and responds
...
- asking Intellect to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Intellect loop.

## Tuning CLI behavior

### Silence threshold

If Intellect starts/stops too aggressively, tune:
...
Intellect stays a normal chat bot, but can speak replies.
...
- you want Intellect to function like a portable research or ops assistant
...
Intellect joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Intellect detects speech boundaries
- transcripts are posted in the associated text channel
- Intellect responds in text and audio
...
1. get text Intellect working
2. install `intellect-agent[voice]`
