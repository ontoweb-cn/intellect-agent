...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Intellect Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Intellect Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Intellect core? Start with [Build an Intellect Plugin](../guides/build-an-intellect-plugin.md)
- Building a new built-in core tool for Intellect itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.intellect/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.intellect` — use `get_intellect_home()` from `intellect_constants` for code paths and `display_intellect_home()` for user-facing messages. See [AGENTS.md](https://gitee.com/ontoweb/intellect-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.

## Cross-Platform Compatibility

Intellect officially supports **Linux, macOS, WSL2, and native Windows (early beta — via PowerShell install)**.  Native Windows uses Git Bash (from [Git for Windows](https://git-scm.com/download/win)) for shell commands.  A few features require POSIX kernel primitives and are gated. The native-Windows path is new and moves fast — if you're doing Windows-heavy dev, expect to hit and fix rough edges.
...
- **Discord**: [discord.gg/ONTOWEB](https://discord.gg/ONTOWEB)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://gitee.com/ontoweb/intellect-agent/blob/main/LICENSE).
