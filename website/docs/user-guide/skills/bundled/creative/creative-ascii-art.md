...
```bash
python3 -m pyfiglet "INTELLECT" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=INTELLECT&font=Slant" | boxes -d stone
```
