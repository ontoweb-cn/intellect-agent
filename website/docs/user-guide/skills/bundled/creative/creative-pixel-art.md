...
```python
import sys
sys.path.insert(0, "/home/teknium/.intellect/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.intellect/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Intellect installs package this)
