...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/productivity/siyuan` |
...
```yaml
# In ~/.intellect/config.yaml under mcp_servers:
mcp_servers:
  siyuan:
    command: npx
