...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/health/neuroskill-bci` |
...
Connect Intellect to a running [NeuroSkill](https://neuroskill.com/) instance to read
