...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/research/qmd` |
...
Intellect Agent via the native MCP client. This is the preferred
...
Then configure Intellect Agent to connect via HTTP:
