...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Intellect Agent |
| License | MIT |
...
import upstream classes into Intellect itself.
...
```bash
mkdir -p ~/.intellect/cache/darwinian-evolver && cd ~/.intellect/cache/darwinian-evolver
...
```bash
cd ~/.intellect/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.intellect/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.intellect/skills/research/darwinian-evolver
DE_DIR=~/.intellect/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Intellect core.
   Custom driver scripts under `~/.intellect/skills/...` are user-side and fine.
