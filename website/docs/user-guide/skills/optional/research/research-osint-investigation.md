...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Intellect Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $intellect_OSINT_CACHE/icij/ (default: ~/.cache/intellect-osint/icij/).
...
# Set intellect_OSINT_UA=your-app/1.0 (your@email) to identify yourself
