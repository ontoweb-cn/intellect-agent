...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/mlops/stable-diffusion` |
...
- **[Advanced Usage](https://gitee.com/ontoweb/intellect-agent/blob/main/optional-skills/mlops/stable-diffusion/references/advanced-usage.md)** - Custom pipelines, fine-tuning, deployment
- **[Troubleshooting](https://gitee.com/ontoweb/intellect-agent/blob/main/optional-skills/mlops/stable-diffusion/references/troubleshooting.md)** - Common issues and solutions
