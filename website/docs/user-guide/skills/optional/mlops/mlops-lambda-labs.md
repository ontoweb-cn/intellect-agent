...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/mlops/lambda-labs` |
...
- **[Advanced Usage](https://gitee.com/ontoweb/intellect-agent/blob/main/optional-skills/mlops/lambda-labs/references/advanced-usage.md)** - Multi-node training, API automation
- **[Troubleshooting](https://gitee.com/ontoweb/intellect-agent/blob/main/optional-skills/mlops/lambda-labs/references/troubleshooting.md)** - Common issues and solutions
