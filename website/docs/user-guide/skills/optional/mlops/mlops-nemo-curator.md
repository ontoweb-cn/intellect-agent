...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/mlops/nemo-curator` |
...
- **[Filtering Guide](https://gitee.com/ontoweb/intellect-agent/blob/main/optional-skills/mlops/nemo-curator/references/filtering.md)** - 30+ quality filters, heuristics
- **[Deduplication Guide](https://gitee.com/ontoweb/intellect-agent/blob/main/optional-skills/mlops/nemo-curator/references/deduplication.md)** - Exact, fuzzy, semantic methods
