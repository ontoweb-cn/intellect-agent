...
- User wants **Intellect itself to drive a browser** → use Intellect' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
