...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Intellect Agent |
| License | MIT |
...
The script reads `~/.intellect/.env` for two optional defaults:
...
Helper script: `~/.intellect/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.intellect/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.intellect/.env`.
...
```bash
python3 ~/.intellect/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.intellect/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
