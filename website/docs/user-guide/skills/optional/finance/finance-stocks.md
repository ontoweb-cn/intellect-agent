...
| | |
|---|---|
| Source | Optional — install with `intellect skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Intellect Agent |
| License | MIT |
...
```
SCRIPT=~/.intellect/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.intellect/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
