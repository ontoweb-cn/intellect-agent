...
slug: /
sidebar_position: 0
title: "Intellect Agent Documentation"
description: "The self-improving AI agent built by ONTOWEB. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [ONTOWEB](https://ontoweb.cn). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://gitee.com/ontoweb/intellect-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
After installing, run `intellect setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [ONTOWEB Portal](/integrations/ontoweb-portal).
:::

## What is Intellect Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Intellect safely |
| 🧭 **[Use MCP with Intellect](/guides/use-mcp-with-intellect)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Intellect](/guides/use-voice-mode-with-intellect)** | Hands-on setup and usage patterns for Intellect voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Intellect' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Intellect |
...
- **Built by model trainers** — Created by [ONTOWEB](https://ontoweb.cn), the lab behind Intellect, Nomos, and Psyche. Works with [ONTOWEB Portal](https://portal.ontoweb.cn), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [ONTOWEB Portal](/integrations/ontoweb-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [ONTOWEB](https://ontoweb.cn) — the lab behind Intellect, Nomos, and Psyche models
