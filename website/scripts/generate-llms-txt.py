#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Intellect docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Intellect as a Python Library", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Intellect"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Intellect Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by ONTOWEB. A terminal-native "
        ...
        "backends. Works with ONTOWEB Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
    ...
    lines.append("")
    lines.append("Repo: https://gitee.com/ontoweb/intellect-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Intellect Agent — Full Documentation\n",
        (
            "This file is the entire Intellect Agent documentation concatenated for LLM "
