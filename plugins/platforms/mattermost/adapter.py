...
required — uses aiohttp which is already an Intellect dependency.
...
def interactive_setup() -> None:
    ...
    ``intellect_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Intellect delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # intellect_cli/setup.py::_setup_mattermost function.
