...
try:
    ...
    _intellect_VERSION = "0.0.0"

_APP_VERSION = _intellect_VERSION
_BOT_VERSION = _intellect_VERSION
_YUANBAO_INSTANCE_ID = str(intellect_INSTANCE_ID)  # single source: yuanbao_proto.intellect_INSTANCE_ID
