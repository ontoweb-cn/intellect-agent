...
``_check_spotify_available()`` — when the user has not run ``intellect auth
spotify``, the tools remain registered (so they appear in ``intellect
...
The Spotify auth flow (``intellect auth spotify``), CLI plumbing, and docs
