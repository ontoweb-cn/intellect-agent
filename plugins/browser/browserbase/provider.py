...
credentials. Managed OntoWeb gateway support has been removed — the OntoWeb
...
class BrowserbaseBrowserProvider(BrowserProvider):
    ...
    Direct credentials only — managed-OntoWeb-gateway support lives on the
    ...
    def create_session(self, task_id: str) -> Dict[str, object]:
        ...
        _req = require_requests(requests, plugin="browserbase")
