...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_intellect_agent_browser()
    ),
...
def _has_intellect_agent_browser() -> bool:
    ...
    # install.sh installs globally into $INTELLECT_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-intellectHome", str(get_intellect_home()),
        ]
    else:
