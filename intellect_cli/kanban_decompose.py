...
Invoked by ``intellect kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Intellect Agent board.
...
def _profile_author() -> str:
    """Mirror of ``intellect_cli.kanban._profile_author``."""
    return (
