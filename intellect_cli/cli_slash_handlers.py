"""Slash command handlers mixin for IntellectCLI.

Extracted from ``cli.py`` — contains all ``_handle_*`` methods that process
slash commands (``/model``, ``/cron``, ``/browser``, etc.).
"""
...
class SlashCommandMixin:
    """Mixin providing _handle_* slash command handlers."""
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from cli import display_intellect_home
        ...
        if subcmd in {"list", "ls"}:
            ...
            try:
                ...
                logger.debug("exceptValueError block", exc_info=True)
    ...
    def _handle_paste_command(self):
        ...
        """
        from cli import _DIM, _RST, _cprint, _is_termux_environment, _termux_example_image_path
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        from cli import _DIM, _IMAGE_EXTENSIONS, _RST, _cprint, _is_termux_environment, _resolve_attachment_path, _split_path_input, _termux_example_image_path
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        if not self._session_db:
            try:
                ...
                logger.debug("exceptException block", exc_info=True)
        if not self._session_db:
    ...
    def _handle_branch_command(self, cmd_original: str) -> None:
        ...
        """
        from cli import _cprint, _sync_process_session_id, get_intellect_home
    ...
    def _handle_background_command(self, cmd: str):
        ...
        """
        from cli import _accent_hex, _cprint, _maybe_remap_for_light_mode, _render_final_assistant_content
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        """
        from cli import _BOLD, _DIM, _RST, _accent_hex, _cprint, _escape
        try:
        ...
        if sub.startswith("connect"):
            ...
            if current:
                ...
                try:
                    ...
                    logger.debug("except(ValueError, IndexError) block", exc_info=True)
                try:
                    import socket
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        from cli import _ACCENT, display_intellect_home, save_config_value
        try:
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        """
        from cli import _Colors, _cprint, save_config_value
        from intellect_cli.config import load_config
