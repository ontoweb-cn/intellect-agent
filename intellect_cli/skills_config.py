"""
Skills configuration for Intellect Agent.
`intellect skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.intellect/config.yaml under:
...
from intellect_cli.config import cfg_get, load_config, save_config
from intellect_cli.colors import Colors, color
from intellect_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `intellect skills`."""
    from intellect_cli.curses_ui import curses_checklist
