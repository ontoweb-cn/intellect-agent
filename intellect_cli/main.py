...
def _cmd_oauth_add(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)
...
def _cmd_members_bootstrap(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_audit(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_invite(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_register(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)
...
def _cmd_members_list(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_show(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_add(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_activate(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_deactivate(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_delete(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_grant_owner(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_bind(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_identities(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_workspace(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_login(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)
...
def _cmd_members_logout(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_whoami(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_role(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_passwd(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)

def _cmd_members_reset(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)
...
def _cmd_members_projects(*a, **kw):
    return 1  # (deprecated — multi-user removed in v0.5.0)
