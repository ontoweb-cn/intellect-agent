...
def cmd_members(args):
    ...
    print(
        ...
        "Use profiles (intellect -p <name>) for isolation, or intellect oauth "
        "for provider OAuth.",
        file=sys.stderr,
    )
    sys.exit(1)
...
def main():
    ...
    # =========================================================================
    # members command (removed — single-user mode)
    # =========================================================================
    members_parser = subparsers.add_parser(
        "members",
        help="[removed] Multi-user features were removed in v0.5.0",
        description=(
            "Multi-user members/teams/projects were removed in v0.5.0. "
            "This command always exits with an error. Use profiles "
            "(``intellect -p``) for isolation, and ``intellect oauth`` for "
            "provider OAuth."
        ),
    )
