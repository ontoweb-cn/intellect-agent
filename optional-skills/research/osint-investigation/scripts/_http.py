...
DEFAULT_UA = (
    "intellect-osint-investigation/0.2 "
    "(+https://gitee.com/ontoweb/intellect-agent; "
    "set intellect_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("intellect_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
