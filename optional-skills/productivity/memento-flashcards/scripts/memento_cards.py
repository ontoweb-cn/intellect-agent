...
Data file: $INTELLECT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_INTELLECT_HOME = Path(os.environ.get("INTELLECT_HOME", Path.home() / ".intellect"))
DATA_DIR = _INTELLECT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
